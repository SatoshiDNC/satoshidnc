...
q.codePointAt(0),g=this.findGlyph(f),-1==g)console.log(`Missing glyph: decimal ${f} hex ${f.toString(16)}`);else{this.objX+=-this.glyphX1[g];this.objY+=-this.glyphHeights[g]+this.glyphY1[g];if(g<this.glyphCodes.length&&(1<this.glyphWidths[g]||1<this.glyphHeights[g])){f=this.objX+0;m=this.objY+this.glyphHeights[g];h=this.objX+this.glyphWidths[g];var c=this.objY+0,b=this.glyphSourceX[g]/this.texWidth,a=(this.glyphSourceY[g]+this.glyphHeights[g])/(2*this.texHeight),l=(this.glyphSourceX[g]+this.glyphWidths[g])/this.texWidth,
