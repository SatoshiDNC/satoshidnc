...
this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}setRenderFlag(a){super.setRenderFlag(!0)}renderAll(){super.renderAll();if(this.a&&(this.a.needsRender||this.a.childRender)||this.b&&(this.b.needsRender||this.b.childRender)){this.b.renderAll();const a=this.ghostOpacity||.5;0<a&&(k.clearColor(...(this.ghostColor||setAlpha(this.b?.bgColor,a)||[.5,.5,.5,a])),k.clear(k.COLOR_BUFFER_BIT));this.a.renderAll(!1)}}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ga extends U{constructor(a,
...
(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)?!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"tr"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState=
"b",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;this.state=this.stateNew}if(1<this.type.length){e=0;var h=Date.now();0!=this.prevTime&&(e=h-this.prevTime);this.prevTime=h;17<e&&(e=17);a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)+2&&(this.stateNew=this.wideState);a.remainingHeight*this.threshold>a.remainingWidth*(1-this.threshold)+2&&(this.stateNew=this.tallState);if(this.stateNew!=this.state||0<this.stateProg)this.stateNew!=this.state?(this.stateProg+=
.008*e,1<=this.stateProg&&(this.stateProg=1,this.state=this.stateNew),-1===B.indexOf(this)&&B.push(this)):(this.stateProg-=.008*e,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===B.indexOf(this)&&B.push(this))}this.layoutFunc&&this.state!=g&&0<this.w&&0<this.h&&this.layoutFunc.call(this);e="t"==this.state||"b"==this.state?b/a.remainingWidth:f/a.remainingHeight;g=1-this.stateProg*(1-e);e=1-this.stateProg*(0+e);"l"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),
c.remainingX=a.remainingX,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=~~(a.remainingHeight*e),d.remainingX=a.remainingX+b,"t"==this.tallState?(c.remainingY=a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"r"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX+a.remainingWidth-b,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=
~~(a.remainingHeight*e),d.remainingX=a.remainingX,"t"==this.tallState?(c.remainingY=a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"t"==this.state?(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY+f,"l"==this.wideState?(c.remainingX=a.remainingX,
...
this.a.layoutFunc!==this.layoutPageFunc&&(this.a.layoutFunc&&(this.a.layoutFunc_=this.a.layoutFunc),this.a.layoutFunc=this.layoutPageFunc);this.b&&this.b.layoutFunc!==this.layoutPageFunc&&(this.b.layoutFunc&&(this.b.layoutFunc_=this.b.layoutFunc),this.b.layoutFunc=this.layoutPageFunc);g&&(n.pageBlurFunc&&n.pageBlurFunc(),e.pageFocusFunc&&e.pageFocusFunc());h=Math.round(h*this.viewScale);l=Math.round(l*this.viewScale);c.remainingWidth=Math.min(Math.max(a.remainingWidth-Math.abs(h),0),a.remainingWidth);
...
1,this.state=this.stateNew),-1===B.indexOf(this)&&B.push(this)):(this.stateProg-=.008*e,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===B.indexOf(this)&&B.push(this))}this.layoutFunc&&this.state!=g&&0<this.w&&0<this.h&&this.layoutFunc.call(this);e="t"==this.state||"b"==this.state?b/a.remainingWidth:f/a.remainingHeight;g=1-this.stateProg*(1-e);e=1-this.stateProg*(0+e);"l"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX,d.remainingWidth=
...
c=this.extendedHulls[f];var b=this.boundingBoxes[f],g=1/d.getScale();f=vec3.create();f[0]=a.x-d.x-this.x/g;f[1]=a.y-d.y-this.y/g;var e=mat4.create();mat4.invert(e,d.userMat);vec3.transformMat4(f,f,e);f=(a.x-d.x-d.ox)*g+d.userX-this.x-this.xo;d=(a.y-d.y-d.oy)*g+d.userY-this.y-this.yo;if(!(f<b.x1||f>=b.x2||d<b.y1||d>=b.y2)){g=c.length;b=!0;for(e=0;e<g;e+=2){var h=c[e+0];var l=c[e+1];h=(c[(e+2)%g]-h)*(d-l)-(c[(e+3)%g]-l)*(f-h);0>h&&(b=!1)}if(b){g=this.convexHull.length;b=!0;for(e=0;e<g;e+=2)c=this.convexHull[e+
0],h=this.convexHull[e+1],h=(this.convexHull[(e+2)%g]-c)*(d-h)-(this.convexHull[(e+3)%g]-h)*(f-c),0>h&&(b=!1);c=0;b||(c=this.distToHull(f,d));a.hits.push({gad:this,dist:c})}}}}autoHull(){this.convexHull=this.computeHull([0,0,this.w,0,this.w,this.h,0,this.h]);this.extendedHulls={};this.boundingBoxes={}}computeHull(a){function c(t,v,A,E,L,M){return(A-t)*(M-v)-(E-v)*(L-t)}function d(t){return t*t}function f(t,v,A,E,L,M){var H=d(A-L)+d(E-M);if(0==H)return d(t-A)+d(v-E);H=Math.max(0,Math.min(1,((t-A)*
(L-A)+(v-E)*(M-E))/H));E+=H*(M-E);return d(t-(A+H*(L-A)))+d(v-E)}function b(t,v,A,E,L,M){if(!(2>v.length)){for(var H=0,R=0,y=0;y<~~(v.length/2);y++){var S=Math.sqrt(f(v[2*y],v[2*y+1],A,E,L,M));S>R&&(R=S,H=y)}R=v[2*H];S=v[2*H+1];v.splice(2*H,2);for(y=0;y<~~(t.length/2);y++)if(t[2*y]==A&&t[2*y+1]==E&&t[(2*y+2)%t.length]==L&&t[(2*y+3)%t.length]==M||t[2*y]==L&&t[2*y+1]==M&&t[(2*y+2)%t.length]==A&&t[(2*y+3)%t.length]==E){t.splice(2*y+2,0,R,S);break}H=[];var Y=[];for(y=0;y<~~(v.length/2);y++)0>c(A,E,R,
S,v[2*y],v[2*y+1])&&(H[H.length]=v[2*y],H[H.length]=v[2*y+1]),0>c(R,S,L,M,v[2*y],v[2*y+1])&&(Y[Y.length]=v[2*y],Y[Y.length]=v[2*y+1]);b(t,H,A,E,R,S);b(t,Y,R,S,L,M)}}for(var g=[...a],e=[],h=0,l=0,n=g[0],q=g[0],r=0;r<~~(g.length/2);r++)g[2*r]<n&&(n=g[2*r],h=r),g[2*r]>q&&(q=g[2*r],l=r);e[e.length]=g[2*h];e[e.length]=g[2*h+1];e[e.length]=g[2*l];e[e.length]=g[2*l+1];g.splice(2*h,2);l<h?g.splice(2*l,2):g.splice(2*l-2,2);n=[];q=[];for(r=0;r<~~(g.length/2);r++)0>c(a[2*h],a[2*h+1],a[2*l],a[2*l+1],g[2*r],g[2*
r+1])?(n[n.length]=g[2*r],n[n.length]=g[2*r+1]):(q[q.length]=g[2*r],q[q.length]=g[2*r+1]);b(e,n,a[2*h],a[2*h+1],a[2*l],a[2*l+1]);b(e,q,a[2*l],a[2*l+1],a[2*h],a[2*h+1]);for(a=1;a;)for(r=a=0;r<~~(e.length/2);r++)if(.01>Math.sqrt(f(e[(2*r+2)%e.length],e[(2*r+3)%e.length],e[2*r],e[2*r+1],e[(2*r+4)%e.length],e[(2*r+5)%e.length]))){e.splice(2*r+2,2);a=1;break}return this.sortHull(e)}sortHull(a){function c(q){for(q=Math.atan2(a[q+1]-b,a[q+0]-f)-Math.atan2(l-b,h-f);q>Math.PI;)q-=2*Math.PI;for(;q<-Math.PI;)q+=
2*Math.PI;return q}for(var d=[],f=0,b=0,g=a.length,e=0;e<g;e+=2)f+=a[e+0],b+=a[e+1];f/=g/2;b/=g/2;for(var h=f+102,l=b+1;0<a.length;){g=0;var n=c(0);for(e=0;e<a.length;e+=2)c(e)<n&&(g=e,n=c(e));d.push(a[g+0]);d.push(a[g+1]);a.splice(g,2)}return d}computeExtendedHull(a){for(var c=[],d=0,f=this.convexHull.length,b=0;b<f;b+=2){var g=this.convexHull[(b+3)%f]-this.convexHull[b+1],e=-(this.convexHull[(b+2)%f]-this.convexHull[b+0]),h=a/Math.sqrt(g*g+e*e);c[d+0]=this.convexHull[b+0]+g*h;c[d+1]=this.convexHull[b+
1]+e*h;d+=2;c[d+0]=this.convexHull[(b+2)%f]+g*h;c[d+1]=this.convexHull[(b+3)%f]+e*h;d+=2}for(b=0;b<f;b+=2){g=this.convexHull[(b+2)%f]-this.convexHull[b+0];e=this.convexHull[(b+3)%f]-this.convexHull[b+1];d=this.convexHull[(b-2+f)%f]-this.convexHull[b+0];var l=this.convexHull[(b-1+f)%f]-this.convexHull[b+1];h=Math.sqrt(g*g+e*e);l=Math.tan((Math.PI-Math.acos((g*d+e*l)/(h*Math.sqrt(d*d+l*l))))/4)*a;d=2*b;g=c[d+0]-c[d+2];e=c[d+1]-c[d+3];h=Math.sqrt(g*g+e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+0]=g+c[d+2];c[d+
...
l}function f(l,n,q,r,t,v){var A=d(q-t)+d(r-v);if(0==A)return d(l-q)+d(n-r);A=Math.max(0,Math.min(1,((l-q)*(t-q)+(n-r)*(v-r))/A));r+=A*(v-r);return d(l-(q+A*(t-q)))+d(n-r)}for(var b=this.convexHull,g=Math.sqrt(f(a,c,b[0],b[1],b[2],b[3])),e=2;e<b.length;e+=2){var h=Math.sqrt(f(a,c,b[e+0],b[e+1],b[(e+2)%b.length],b[(e+3)%b.length]));h<g&&(g=h)}return g}}class Ja extends X{constructor(a){super(a);this.dragBeginFunc=function(c){this.tempX=c.ox-this.viewport.x;this.tempY=c.oy-this.viewport.y};this.dragMoveFunc=
function(c){var d=this.viewport.parent,f="h"==d.state,b=f?c.y-this.tempY-d.a.y:c.x-this.tempX-d.a.x;d.ratio=Math.max(0,Math.min(1,b/(b+(f?d.y+d.h-(c.y-this.tempY+this.viewport.h):d.x+d.w-(c.x-this.tempX+this.viewport.w)))));d.setPoint||(d.setPoint={});d.setPoint[d.state]=d.ratio;-1===B.indexOf(this.viewport.parent)&&B.push(this.viewport.parent)};this.dragEndFunc=function(c){delete this.tempX;delete this.tempY}}layout(){var a=this.viewport,c=a.getScale(),d=a.parent.size,f="h"==a.parent.state;var b=
f?Math.max(1,a.w)/c:d;a=f?d:Math.max(1,a.h)/c;this.actionFlags=f?m.GAF_DRAGGABLE_UPDOWN:m.GAF_DRAGGABLE_LEFTRIGHT;this.convexHull=this.computeHull([0,0,0,a,b,a,b,0]);this.extendedHulls={};this.boundingBoxes={}}}class Ka extends X{getTargetMat(){return this.targetGad?this.targetGad.mat:this.targetView.userMat}constructor(a){super(a);this.targetView=a;this.targetGad=void 0;this.dragBeginFunc=function(c){var d=this.targetView;this.grab1b=vec3.create();this.grab1b[0]=c.x-d.x;this.grab1b[1]=c.y-d.y;this.viewMat=
