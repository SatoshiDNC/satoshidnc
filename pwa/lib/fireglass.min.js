...
this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}setRenderFlag(a){super.setRenderFlag(!0)}renderAll(){super.renderAll();if(this.a&&(this.a.needsRender||this.a.childRender)||this.b&&(this.b.needsRender||this.b.childRender)){this.b.renderAll();this.clip();var a=this.ghostOpacity;void 0===a&&(a=.5);if(0<a||this.ghostColor?.[3]){let c=this.ghostColor;!c&&this.b?.bgColor&&(c=[this.b.bgColor[0],this.b.bgColor[1],this.b.bgColor[2],a]);xa();k.enable(k.BLEND);k.uniform4fv(k.getUniformLocation(z,"uVertexColor"),
new Float32Array(c||[.5,.5,.5,a]));a=mat4.create();mat4.identity(a);k.uniformMatrix4fv(k.getUniformLocation(z,"uProjectionMatrix"),!1,a);mat4.translate(a,a,[-1,-1,0]);mat4.scale(a,a,[2,2,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,a);k.drawArrays(k.TRIANGLE_FAN,A.unitSquare,E.unitSquare)}this.a.renderAll(!1)}}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ha extends U{constructor(a,c,d,f){super(a);this.type=c;this.stateNew=this.state="";this.stateProg=
0;this.sizeH=d;this.sizeV=f?f:d;this.prop=!1;this.threshold=.5;this.b=this.a=void 0;this.prevTime=0;this.tallState=this.wideState="";"t l r b tl tr bl br".split(" ").includes(this.type)||console.error("Warning: Invalid 'type' for SliceView.")}layoutAll(a){super.layoutAll(a);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){var f=~~(this.sizeH*(this.prop?this.w:this.getScale())),b=~~(this.sizeV*(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=
a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)?!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"tr"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;
this.state=this.stateNew}if(1<this.type.length){e=0;var h=Date.now();0!=this.prevTime&&(e=h-this.prevTime);this.prevTime=h;17<e&&(e=17);a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)+2&&(this.stateNew=this.wideState);a.remainingHeight*this.threshold>a.remainingWidth*(1-this.threshold)+2&&(this.stateNew=this.tallState);if(this.stateNew!=this.state||0<this.stateProg)this.stateNew!=this.state?(this.stateProg+=.008*e,1<=this.stateProg&&(this.stateProg=1,this.state=this.stateNew),
-1===C.indexOf(this)&&C.push(this)):(this.stateProg-=.008*e,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===C.indexOf(this)&&C.push(this))}this.layoutFunc&&this.state!=g&&0<this.w&&0<this.h&&this.layoutFunc.call(this);e="t"==this.state||"b"==this.state?b/a.remainingWidth:f/a.remainingHeight;g=1-this.stateProg*(1-e);e=1-this.stateProg*(0+e);"l"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=
~~(a.remainingHeight*e),d.remainingX=a.remainingX+b,"t"==this.tallState?(c.remainingY=a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"r"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX+a.remainingWidth-b,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=~~(a.remainingHeight*e),d.remainingX=a.remainingX,"t"==this.tallState?(c.remainingY=
a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"t"==this.state?(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY+f,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+
a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX)):"b"==this.state&&(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY+a.remainingHeight-f,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX))}else c.clear(),
d.clear();this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ia extends U{constructor(a,c){super(a);this.type=c;this.indexProg=this.indexNew=this.index=0;this.b=this.a=void 0;this.pages=[];this.snaps=[];this.prevTime=0;this.keepPageFlag=!1;this.gadgets.push(this.swipeGad=
new m.SwipeGadget(this));switch(this.type){case "h":this.swipeGad.actionFlags=m.GAF_SWIPEABLE_LEFTRIGHT|m.GAF_SCROLLABLE_LEFTRIGHT;break;case "v":this.swipeGad.actionFlags=m.GAF_SWIPEABLE_UPDOWN|m.GAF_SCROLLABLE_UPDOWN;break;default:this.swipeGad.actionFlags=0}this.layoutFunc=function(){0!=this.pages.length&&(this.minX=0,this.maxX=this.sw*this.pages.length,this.minY=0,this.maxY=this.sh*this.pages.length,this.swipeGad.layout.call(this.swipeGad))};this.layoutPageFunc=function(){this.sw=this.parent.sw;
this.sh=this.parent.sh;this.layoutFunc_&&this.layoutFunc_()};this.toPage=function(d){var f=this.swipeGad;d=Math.min(Math.max(d,0),this.pages.length);d>this.index?f.doSwipe(!0,d):d<this.index&&f.doSwipe(!1,d)}}keepPage(){this.keepPageFlag=!0}getPageIndex(a){for(var c=0;c<this.pages.length;c++)if(this.pages[c]===a)return c;return-1}getPageOffset(a){return"h"==this.type?this.userX-a*this.sw:this.userY-a*this.sh}layoutAll(a){super.layoutAll(a);if(0!=this.pages.length){var c=new I(a.totalWidth,a.totalHeight),
d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){this.prevTime=Date.now();var f="h"==this.type,b="v"==this.type;this.snaps=[];for(var g=0;g<this.pages.length;g++)this.snaps.push([this.sw*g*(f?1:0),this.sh*g*(b?1:0)]);if(this.viewScale!=this.prevScale||this.keepPageFlag)this.userX=this.index*this.sw,this.prevScale=this.viewScale,this.keepPageFlag=!1;var e=this.index;g=!1;f&&(this.index=Math.min(Math.max(Math.round(this.userX/this.sw),0),this.pages.length-1));b&&(this.index=Math.min(Math.max(Math.round(this.userY/
this.sh),0),this.pages.length-1));this.index!=e&&this.pageChangeFunc&&(g=!0,this.pageChangeFunc.call(this));e=this.pages[this.index];var h=this.userX+(f?-this.index*this.sw:0),l=this.userY+(b?-this.index*this.sh:0),n=void 0;if(f&&this.index*this.sw>this.userX||b&&this.index*this.sh>this.userY){f&&(e.userX=0);b&&(e.userY=0);var q=this.index-1;if(0<=q&&q<this.pages.length){n=this.pages[q];q=this.userX+(f?-this.index*this.sw+this.sw:0);var r=this.userY+(b?-this.index*this.sh+this.sh:0);f&&(n.userX=f?
q*this.viewScale/n.viewScale:0);b&&(n.userY=b?r*this.viewScale/n.viewScale:0)}}else f&&this.index*this.sw<this.userX||b&&this.index*this.sh<this.userY?(f&&(e.userX=f?h*this.viewScale/e.viewScale:0),b&&(e.userY=b?l*this.viewScale/e.viewScale:0),q=this.index+1,0<=q&&q<this.pages.length&&(n=this.pages[q],f&&(n.userX=0),b&&(n.userY=0))):(f&&(e.userX=0),b&&(e.userY=0));this.a=e;e.parent=this;if(this.b=n)n.parent=this;this.a&&this.a.layoutFunc!==this.layoutPageFunc&&(this.a.layoutFunc&&(this.a.layoutFunc_=
this.a.layoutFunc),this.a.layoutFunc=this.layoutPageFunc);this.b&&this.b.layoutFunc!==this.layoutPageFunc&&(this.b.layoutFunc&&(this.b.layoutFunc_=this.b.layoutFunc),this.b.layoutFunc=this.layoutPageFunc);g&&(n.pageBlurFunc&&n.pageBlurFunc(),e.pageFocusFunc&&e.pageFocusFunc());h=Math.round(h*this.viewScale);l=Math.round(l*this.viewScale);c.remainingWidth=Math.min(Math.max(a.remainingWidth-Math.abs(h),0),a.remainingWidth);c.remainingHeight=Math.min(Math.max(a.remainingHeight-Math.abs(l),0),a.remainingHeight);
c.remainingX=Math.min(Math.max(a.remainingX-(0>h?h:0),a.remainingX),a.remainingX+a.remainingWidth);c.remainingY=Math.min(Math.max(a.remainingY-(0>l?l:0),a.remainingY),a.remainingY+a.remainingHeight);n?f?(d.remainingWidth=a.remainingWidth-c.remainingWidth,d.remainingHeight=a.remainingHeight,d.remainingX=a.remainingX,d.remainingY=a.remainingY,c.remainingX==a.remainingX&&(d.remainingX+=c.remainingWidth)):b&&(d.remainingWidth=a.remainingWidth,d.remainingHeight=a.remainingHeight-c.remainingHeight,d.remainingX=
a.remainingX,d.remainingY=a.remainingY,c.remainingY==a.remainingY&&(d.remainingY+=c.remainingHeight)):d.clear()}else c.clear(),d.clear();this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){super.getHits(a,c);this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ja extends U{constructor(a,c,d,f){super(a);this.type=
c;this.stateNew=this.state="";this.stateProg=0;this.sizeH=d;this.sizeV=f?f:d;this.prop=!1;this.threshold=.5;this.b=this.a=void 0;this.prevTime=0;this.tallState=this.wideState=""}layoutAll(a){super.layoutAll(a);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){var f=~~(this.sizeH*(this.prop?this.w:this.getScale())),b=~~(this.sizeV*(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=a.remainingWidth*this.threshold>a.remainingHeight*
(1-this.threshold)?!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"tr"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;this.state=this.stateNew}if(1<this.type.length){e=
...
this.b&&this.b.layoutAll(d)}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Da extends U{constructor(a){super(a);this.gadgets.push(a=new X(this));a.w=1E3;a.h=1E3;a.convexHull=a.computeHull([0,0,0,1E3,1E3,1E3,1E3,0]);a.click=function(){}}}class X{constructor(a){this.viewport=a;this.mat=mat4.create();mat4.identity(this.mat);
this.H=this.h=this.w=this.y=this.x=0;this.convexHull=[];this.extendedHulls={};this.boundingBoxes={};this.yo=this.xo=0;this.enabled=!0;this.selected=!1;this.actionFlags=0}getHits(a,c){if(this.enabled&&0!=this.convexHull.length){var d=this.viewport,f=vec3.create();mat4.getScaling(f,d.userMat);c=c/d.getScale()/f[0];f=""+c;f in this.extendedHulls||(this.computeExtendedHull(c),this.computeBoundingBox(c));c=this.extendedHulls[f];var b=this.boundingBoxes[f],g=1/d.getScale();f=vec3.create();f[0]=a.x-d.x-
this.x/g;f[1]=a.y-d.y-this.y/g;var e=mat4.create();mat4.invert(e,d.userMat);vec3.transformMat4(f,f,e);f=(a.x-d.x-d.ox)*g+d.userX-this.x-this.xo;d=(a.y-d.y-d.oy)*g+d.userY-this.y-this.yo;if(!(f<b.x1||f>=b.x2||d<b.y1||d>=b.y2)){g=c.length;b=!0;for(e=0;e<g;e+=2){var h=c[e+0];var l=c[e+1];h=(c[(e+2)%g]-h)*(d-l)-(c[(e+3)%g]-l)*(f-h);0>h&&(b=!1)}if(b){g=this.convexHull.length;b=!0;for(e=0;e<g;e+=2)c=this.convexHull[e+0],h=this.convexHull[e+1],h=(this.convexHull[(e+2)%g]-c)*(d-h)-(this.convexHull[(e+3)%
g]-h)*(f-c),0>h&&(b=!1);c=0;b||(c=this.distToHull(f,d));a.hits.push({gad:this,dist:c})}}}}autoHull(){this.convexHull=this.computeHull([0,0,this.w,0,this.w,this.h,0,this.h]);this.extendedHulls={};this.boundingBoxes={}}computeHull(a){function c(t,v,B,F,L,M){return(B-t)*(M-v)-(F-v)*(L-t)}function d(t){return t*t}function f(t,v,B,F,L,M){var H=d(B-L)+d(F-M);if(0==H)return d(t-B)+d(v-F);H=Math.max(0,Math.min(1,((t-B)*(L-B)+(v-F)*(M-F))/H));F+=H*(M-F);return d(t-(B+H*(L-B)))+d(v-F)}function b(t,v,B,F,L,
M){if(!(2>v.length)){for(var H=0,R=0,y=0;y<~~(v.length/2);y++){var S=Math.sqrt(f(v[2*y],v[2*y+1],B,F,L,M));S>R&&(R=S,H=y)}R=v[2*H];S=v[2*H+1];v.splice(2*H,2);for(y=0;y<~~(t.length/2);y++)if(t[2*y]==B&&t[2*y+1]==F&&t[(2*y+2)%t.length]==L&&t[(2*y+3)%t.length]==M||t[2*y]==L&&t[2*y+1]==M&&t[(2*y+2)%t.length]==B&&t[(2*y+3)%t.length]==F){t.splice(2*y+2,0,R,S);break}H=[];var Y=[];for(y=0;y<~~(v.length/2);y++)0>c(B,F,R,S,v[2*y],v[2*y+1])&&(H[H.length]=v[2*y],H[H.length]=v[2*y+1]),0>c(R,S,L,M,v[2*y],v[2*y+
1])&&(Y[Y.length]=v[2*y],Y[Y.length]=v[2*y+1]);b(t,H,B,F,R,S);b(t,Y,R,S,L,M)}}for(var g=[...a],e=[],h=0,l=0,n=g[0],q=g[0],r=0;r<~~(g.length/2);r++)g[2*r]<n&&(n=g[2*r],h=r),g[2*r]>q&&(q=g[2*r],l=r);e[e.length]=g[2*h];e[e.length]=g[2*h+1];e[e.length]=g[2*l];e[e.length]=g[2*l+1];g.splice(2*h,2);l<h?g.splice(2*l,2):g.splice(2*l-2,2);n=[];q=[];for(r=0;r<~~(g.length/2);r++)0>c(a[2*h],a[2*h+1],a[2*l],a[2*l+1],g[2*r],g[2*r+1])?(n[n.length]=g[2*r],n[n.length]=g[2*r+1]):(q[q.length]=g[2*r],q[q.length]=g[2*
r+1]);b(e,n,a[2*h],a[2*h+1],a[2*l],a[2*l+1]);b(e,q,a[2*l],a[2*l+1],a[2*h],a[2*h+1]);for(a=1;a;)for(r=a=0;r<~~(e.length/2);r++)if(.01>Math.sqrt(f(e[(2*r+2)%e.length],e[(2*r+3)%e.length],e[2*r],e[2*r+1],e[(2*r+4)%e.length],e[(2*r+5)%e.length]))){e.splice(2*r+2,2);a=1;break}return this.sortHull(e)}sortHull(a){function c(q){for(q=Math.atan2(a[q+1]-b,a[q+0]-f)-Math.atan2(l-b,h-f);q>Math.PI;)q-=2*Math.PI;for(;q<-Math.PI;)q+=2*Math.PI;return q}for(var d=[],f=0,b=0,g=a.length,e=0;e<g;e+=2)f+=a[e+0],b+=a[e+
1];f/=g/2;b/=g/2;for(var h=f+102,l=b+1;0<a.length;){g=0;var n=c(0);for(e=0;e<a.length;e+=2)c(e)<n&&(g=e,n=c(e));d.push(a[g+0]);d.push(a[g+1]);a.splice(g,2)}return d}computeExtendedHull(a){for(var c=[],d=0,f=this.convexHull.length,b=0;b<f;b+=2){var g=this.convexHull[(b+3)%f]-this.convexHull[b+1],e=-(this.convexHull[(b+2)%f]-this.convexHull[b+0]),h=a/Math.sqrt(g*g+e*e);c[d+0]=this.convexHull[b+0]+g*h;c[d+1]=this.convexHull[b+1]+e*h;d+=2;c[d+0]=this.convexHull[(b+2)%f]+g*h;c[d+1]=this.convexHull[(b+
3)%f]+e*h;d+=2}for(b=0;b<f;b+=2){g=this.convexHull[(b+2)%f]-this.convexHull[b+0];e=this.convexHull[(b+3)%f]-this.convexHull[b+1];d=this.convexHull[(b-2+f)%f]-this.convexHull[b+0];var l=this.convexHull[(b-1+f)%f]-this.convexHull[b+1];h=Math.sqrt(g*g+e*e);l=Math.tan((Math.PI-Math.acos((g*d+e*l)/(h*Math.sqrt(d*d+l*l))))/4)*a;d=2*b;g=c[d+0]-c[d+2];e=c[d+1]-c[d+3];h=Math.sqrt(g*g+e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+0]=g+c[d+2];c[d+1]=e+c[d+3];d=(b-2+f)%f*2;g=c[d+2]-c[d+0];e=c[d+3]-c[d+1];h=Math.sqrt(g*g+
e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+2]=g+c[d+0];c[d+3]=e+c[d+1]}this.extendedHulls[""+a]=c}computeBoundingBox(a){this.boundingBoxes[""+a]={};var c=this.extendedHulls[""+a];a=this.boundingBoxes[""+a];if(!(2>c.length)){a.x1=c[0];a.x2=c[0];a.y1=c[1];a.y2=c[1];for(var d=2;d<c.length;d+=2)c[d+0]<a.x1&&(a.x1=c[d+0]),c[d+0]>a.x2&&(a.x2=c[d+0]),c[d+1]<a.y1&&(a.y1=c[d+1]),c[d+1]>a.y2&&(a.y2=c[d+1])}}distToHull(a,c){function d(l){return l*l}function f(l,n,q,r,t,v){var B=d(q-t)+d(r-v);if(0==B)return d(l-q)+d(n-
r);B=Math.max(0,Math.min(1,((l-q)*(t-q)+(n-r)*(v-r))/B));r+=B*(v-r);return d(l-(q+B*(t-q)))+d(n-r)}for(var b=this.convexHull,g=Math.sqrt(f(a,c,b[0],b[1],b[2],b[3])),e=2;e<b.length;e+=2){var h=Math.sqrt(f(a,c,b[e+0],b[e+1],b[(e+2)%b.length],b[(e+3)%b.length]));h<g&&(g=h)}return g}}class Ka extends X{constructor(a){super(a);this.dragBeginFunc=function(c){this.tempX=c.ox-this.viewport.x;this.tempY=c.oy-this.viewport.y};this.dragMoveFunc=function(c){var d=this.viewport.parent,f="h"==d.state,b=f?c.y-this.tempY-
d.a.y:c.x-this.tempX-d.a.x;d.ratio=Math.max(0,Math.min(1,b/(b+(f?d.y+d.h-(c.y-this.tempY+this.viewport.h):d.x+d.w-(c.x-this.tempX+this.viewport.w)))));d.setPoint||(d.setPoint={});d.setPoint[d.state]=d.ratio;-1===C.indexOf(this.viewport.parent)&&C.push(this.viewport.parent)};this.dragEndFunc=function(c){delete this.tempX;delete this.tempY}}layout(){var a=this.viewport,c=a.getScale(),d=a.parent.size,f="h"==a.parent.state;var b=f?Math.max(1,a.w)/c:d;a=f?d:Math.max(1,a.h)/c;this.actionFlags=f?m.GAF_DRAGGABLE_UPDOWN:
m.GAF_DRAGGABLE_LEFTRIGHT;this.convexHull=this.computeHull([0,0,0,a,b,a,b,0]);this.extendedHulls={};this.boundingBoxes={}}}class La extends X{getTargetMat(){return this.targetGad?this.targetGad.mat:this.targetView.userMat}constructor(a){super(a);this.targetView=a;this.targetGad=void 0;this.dragBeginFunc=function(c){var d=this.targetView;this.grab1b=vec3.create();this.grab1b[0]=c.x-d.x;this.grab1b[1]=c.y-d.y;this.viewMat=mat4.create();mat4.copy(this.viewMat,d.userMat);this.grabMat=mat4.create();mat4.copy(this.grabMat,
this.getTargetMat());c=mat4.create();mat4.invert(c,this.viewMat);vec3.transformMat4(this.grab1b,this.grab1b,c);this.targetGad&&(c=mat4.create(),mat4.invert(c,this.grabMat),vec3.transformMat4(this.grab1b,this.grab1b,c))};this.dragMoveFunc=function(c){var d=this.targetView,f=vec3.create();f[0]=c.x-d.x;f[1]=c.y-d.y;c=mat4.create();mat4.invert(c,this.viewMat);vec3.transformMat4(f,f,c);this.targetGad&&(c=mat4.create(),mat4.invert(c,this.grabMat),vec3.transformMat4(f,f,c));c=vec3.create();vec3.subtract(c,
f,this.grab1b);this.targetGad&&vec3.scale(c,c,1/d.getScale());mat4.translate(this.getTargetMat(),this.grabMat,c);d.rematrix();d.setRenderFlag(!0)};this.dragEndFunc=function(c){c=this.targetView;delete this.grab1b;delete this.viewMat;delete this.grabMat;c.setRenderFlag(!0)};this.pinchBeginFunc=function(c,d){var f=this.targetView;this.grab1=vec3.create();this.grab1[0]=c.x-f.x;this.grab1[1]=c.y-f.y;this.grab2=vec3.create();this.grab2[0]=d.x-f.x;this.grab2[1]=d.y-f.y;this.viewMat=mat4.create();mat4.copy(this.viewMat,
f.userMat);this.grabMat=mat4.create();mat4.copy(this.grabMat,this.getTargetMat());this.grabC=vec3.create();this.grab1b=vec3.create();vec3.copy(this.grab1b,this.grab1);this.grab2b=vec3.create();vec3.copy(this.grab2b,this.grab2);this.grabCb=vec3.create();c=mat4.create();mat4.invert(c,this.viewMat);vec3.transformMat4(this.grab1b,this.grab1b,c);vec3.transformMat4(this.grab2b,this.grab2b,c);this.targetGad&&(c=mat4.create(),mat4.copy(c,this.grabMat),vec3.transformMat4(this.grab1b,this.grab1b,c),vec3.transformMat4(this.grab2b,
...
this.followUpFunc.call(this))}}let W=()=>{},Z=[];var x=new Da;var ca=-1,na=0,la=0,ka=0,Aa=0,u={};const Q=15*window.devicePixelRatio;return m={initialize:Ba,start:Ca,pushRoot:function(a){Z.push(x);x=a;x.queueLayout();V()},peekRoot:function(){return Z[Z.length-1]},popRoot:function(){x=Z.pop();x.queueLayout();V()},getRoot:function(){return x},setRoot:function(a){Z=[];x=a;x.queueLayout();V()},setDebugFlags:function(a,c){Aa=!!a;la=!!c},setKeystrokeSound:function(a){W=a},getContext:function(){return k},
...
MatrixGadget:La,SwipeGadget:Ma,MiddleDividerGadget:Ka,GAF_CLICKABLE:1,GAF_HOLDABLE:2,GAF_CONTEXTMENU:4,GAF_STRETCHABLE:8,GAF_DRAGGABLE_UPDOWN:16,GAF_DRAGGABLE_LEFTRIGHT:32,GAF_DRAGGABLE:48,GAF_SWIPEABLE_UPDOWN:64,GAF_SWIPEABLE_LEFTRIGHT:128,GAF_SWIPEABLE:192,GAF_SCROLLABLE_UPDOWN:256,GAF_SCROLLABLE_LEFTRIGHT:512,GAF_SCROLLABLE:768,GAF_SCALABLE:1024,GAF_ROTATABLE:2048,GAF_PINCHABLE:3072,GAF_NUMINPUT:4096,GAF_TEXTINPUT:8192,GAF_GONEXT:16384,GAF_BACKNAV:32768,GAF_ALL:3901,HitList:Ea,LayoutState:I}}();
