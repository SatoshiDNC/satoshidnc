...
for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[12,72,0]),mat4.scale(c,c,[46*g.y/D/1E3,6,0]),k.uniformMatrix4fv(k.getUniformLocation(C,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,z.unitSquare,F.unitSquare)}}}window.requestAnimationFrame(xa)}function V(){ja=10;var a;if(oa&&pa){var c=oa;var d=pa;var f=a=1;w.width=c;w.height=d;w.style.width=`${c}px`;w.style.height=`${d}px`}else c=window.innerWidth,d=window.innerHeight,a=window.devicePixelRatio,f=window.visualViewport.scale,
w.width=c*f*a,w.height=d*f*a,w.style.width=`${c*f}px`,w.style.height=`${d*f}px`;ya=Math.sqrt(w.width*w.width+w.height*w.height);D=f*a;ia=!0;x.resizeFunc&&x.resizeFunc.call(x)}function K(a,c){function d(n,q){for(const r of n.hitList.hits)r.gad!==q&&r.gad.ownedBy==g&&(r.gad.gestureState+="-disowned",r.gad.viewport.setRenderFlag(!0),delete r.gad.ownedBy)}function f(n){const q=n.x-n.ox;n=n.y-n.oy;return q*q>n*n?0<q?"right":"left":0<n?"down":"up"}if("touches"==c&&a.touches&&0==a.touches.length){a=[];for(var [,
b]of Object.entries(u))b.tempIsActive="mouse"==b.e.pointerType;for(const [n,q]of Object.entries(u))q.tempIsActive||a.push(n);for(;a.length;)delete u[a.pop()];for(const [,n]of Object.entries(u))delete n.tempIsActive}else{D!=window.visualViewport.scale*window.devicePixelRatio&&V();var g="p-"+a.pointerId;switch(c){case "down":da();u.hasOwnProperty(g)||(u[g]={gestureState:"",touching:!1,px:a.layerX*D,py:a.layerY*D});b=u[g];b.e=a;b.touching=!0;b.x=a.layerX*D;b.y=a.layerY*D;b.ox=b.x;b.oy=b.y;b.hitList=
new m.HitList(b.x,b.y);x.getHits(b.hitList,N());b.hitList.sortHits();if("mouse"==a.pointerType){if(0==a.button)for(const n of b.hitList.hits){var e=n.gad;!e.ownedBy&&e.actionFlags&m.GAF_CLICKABLE&&(e.gestureState="begin-click",e.ownedBy=g,e.viewport.setRenderFlag(!0));!e.ownedBy&&e.actionFlags&m.GAF_DRAGGABLE&&(e.gestureState="begin-drag",e.ownedBy=g,e.viewport.setRenderFlag(!0));!e.ownedBy&&e.actionFlags&(m.GAF_NUMINPUT|m.GAF_TEXTINPUT)&&(e.gestureState="begin-input",e.ownedBy=g,e.viewport.setRenderFlag(!0));
e.gestureTimerId=setTimeout(K,250,a,"drag time reached")}if(2==a.button)for(const n of b.hitList.hits)b=n.gad,!b.ownedBy&&b.actionFlags&m.GAF_CONTEXTMENU&&(b.gestureState="begin-menu",b.ownedBy=g,b.viewport.setRenderFlag(!0),W())}else{e=!1;for(const n of b.hitList.hits)(b=n.gad,b.ownedBy)?b.ownedBy!=g&&("await-pinch"==b.gestureState||b.actionFlags&m.GAF_PINCHABLE&&("begin-drag"==b.gestureState||"begin-tap"==b.gestureState)?(b.gestureState="pinch",b.secondTouch=g,b.viewport.setRenderFlag(!0),b.pinchBeginFunc&&
b.pinchBeginFunc.call(b,u[b.ownedBy],u[b.secondTouch])):"drag"==b.gestureState&&b.actionFlags&m.GAF_PINCHABLE&&(b.gestureState="pinch",b.secondTouch=g,b.viewport.setRenderFlag(!0),b.dragEndFunc&&b.dragEndFunc.call(b,u[b.ownedBy]),b.pinchBeginFunc&&b.pinchBeginFunc.call(b,u[b.ownedBy],u[b.secondTouch]))):b.actionFlags&m.GAF_CLICKABLE&&!e?(b.gestureState="begin-tap",b.ownedBy=g,e=!0,b.viewport.setRenderFlag(!0),b.gestureBeginTime=a.timeStamp,b.actionFlags&(m.GAF_CONTEXTMENU|m.GAF_HOLDABLE|m.GAF_DRAGGABLE)&&
(b.gestureTimerId=setTimeout(K,250,a,"tap-and-hold time reached"))):b.actionFlags&(m.GAF_NUMINPUT|m.GAF_TEXTINPUT)?(b.gestureState="begin-input",b.ownedBy=g,b.viewport.setRenderFlag(!0),b.gestureBeginTime=a.timeStamp,b.actionFlags&m.GAF_CONTEXTMENU&&(b.gestureTimerId=setTimeout(K,250,a,"tap-and-hold time reached"))):b.actionFlags&m.GAF_CONTEXTMENU?(b.gestureState="begin-menu",b.ownedBy=g,b.viewport.setRenderFlag(!0),b.gestureTimerId=setTimeout(K,250,a,"tap-and-hold time reached")):b.actionFlags&m.GAF_HOLDABLE?
(b.gestureState="begin-hold",b.ownedBy=g,b.viewport.setRenderFlag(!0),b.gestureTimerId=setTimeout(K,250,a,"tap-and-hold time reached")):b.actionFlags&m.GAF_DRAGGABLE?(b.gestureState="begin-drag",b.ownedBy=g,b.viewport.setRenderFlag(!0),b.gestureTimerId=setTimeout(K,250,a,"drag time reached")):b.actionFlags&m.GAF_SWIPEABLE?(b.gestureState="begin-swipe",b.ownedBy=g,b.viewport.setRenderFlag(!0)):b.actionFlags&m.GAF_PINCHABLE&&(b.gestureState="await-pinch",b.ownedBy=g,b.viewport.setRenderFlag(!0))}break;
case "move":qa||"mouse"!=a.pointerType||(qa=1,x.enableMouse&&x.enableMouse.call(x));u.hasOwnProperty(g)||(u[g]={gestureState:"mouse"==a.pointerType?"hover":"",touching:"mouse"==a.pointerType?!1:!0});b=u[g];b.e=a;b.px=b.x;b.x=a.layerX*D;b.py=b.y;b.y=a.layerY*D;if("mouse"==a.pointerType){if(b.hitList)for(e of b.hitList.hits){var h=e.gad;if(h.ownedBy==g)switch(h.gestureState){case "begin-click":case "recover-click":a=new m.HitList(b.x,b.y);h.getHits(a,N());0==a.hits.length&&(h.gestureState="abandon-click",
h.viewport.setRenderFlag(!0));break;case "begin-input":a=new m.HitList(b.x,b.y);h.getHits(a,N());0==a.hits.length&&(h.gestureState="abandon-input",h.viewport.setRenderFlag(!0));break;case "hold":a=new m.HitList(b.x,b.y);h.getHits(a,N());0==a.hits.length&&(h.gestureState="abandon-hold",h.viewport.setRenderFlag(!0),h.holdEndFunc&&h.holdEndFunc.call(h,b));break;case "abandon-click":a=new m.HitList(b.x,b.y);h.getHits(a,N());0!=a.hits.length&&(h.gestureState="recover-click",h.viewport.setRenderFlag(!0));
break;case "abandon-hold":a=new m.HitList(b.x,b.y);h.getHits(a,N());0!=a.hits.length&&(h.gestureState="hold",h.viewport.setRenderFlag(!0),h.holdBeginFunc&&h.holdBeginFunc.call(h,b));break;case "begin-drag":a=f(b);Math.sqrt((b.ox-b.x)**2+(b.oy-b.y)**2)>Q&&(h.hasOwnProperty("gestureTimerId")&&(clearTimeout(h.gestureTimerId),delete h.gestureTimerId),("up"==a||"down"==a)&&h.actionFlags&m.GAF_DRAGGABLE_UPDOWN||("left"==a||"right"==a)&&h.actionFlags&m.GAF_DRAGGABLE_LEFTRIGHT)&&(h.gestureState="drag",h.viewport.setRenderFlag(!0),
d(b,h),h.dragBeginFunc&&h.dragBeginFunc.call(h,b),h.dragMoveFunc&&h.dragMoveFunc.call(h,b));break;case "drag":h.dragMoveFunc&&h.dragMoveFunc.call(h,b)}}}else for(h of b.hitList.hits)if(e=h.gad,e.ownedBy==g)switch(e.gestureState){case "begin-tap":if(Math.sqrt((b.ox-b.x)**2+(b.oy-b.y)**2)>Q&&(e.gestureState="invalid-tap",e.viewport.setRenderFlag(!0),!b.swiping))if(a=f(b),("up"==a||"down"==a)&&e.actionFlags&m.GAF_SWIPEABLE_UPDOWN||("left"==a||"right"==a)&&e.actionFlags&m.GAF_SWIPEABLE_LEFTRIGHT){e.gestureState=
