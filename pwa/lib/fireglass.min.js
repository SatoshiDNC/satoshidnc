...
c.focus(),c.select())}function xa(){k.useProgram(A);k.bindBuffer(k.ARRAY_BUFFER,ia);var a=k.getAttribLocation(A,"aVertexPosition");k.vertexAttribPointer(a,2,k.FLOAT,!1,0,0);k.enableVertexAttribArray(a)}function ya(a){if(a!=ca){var c=0;0<ca&&(c=a-ca);ca=a;const b=[];for(;a=C.pop();)b.push(a);if(ja)ja=!1,k.viewport(0,0,w.width,w.height),mat4.identity(O),mat4.translate(O,O,[-1,1,0]),mat4.scale(O,O,[2/w.width,-2/w.height,1]),x&&(a=new m.LayoutState(w.width,w.height),x.layoutAll(a));else for(;a=b.pop();)a.relayout();
ka&&(--ka||x.setRenderFlag(!0));la&&x.setRenderFlag(!0);if(x&&(x.needsRender||x.childRender)){a=0;for(var [,d]of Object.entries(u))d.dx=(d.x-d.px)/c,d.px=d.x,d.dy=(d.y-d.py)/c,d.py=d.y,a+=Math.sqrt(d.dx*d.dx+d.dy*d.dy)/za;ma&&ma.setValueAtTime(a,G.currentTime);x.renderAll();if(Aa){k.viewport(0,0,w.width,w.height);k.disable(k.SCISSOR_TEST);xa();k.enable(k.BLEND);k.uniform4fv(k.getUniformLocation(A,"uVertexColor"),new Float32Array([1,1,1,1]));k.uniformMatrix4fv(k.getUniformLocation(A,"uProjectionMatrix"),
!1,O);c=mat4.create();if(la){d=[];for(var [,f]of Object.entries(u))if(f.hitList){a=f.hitList.getActionableGads(m.GAF_ALL);for(const g of a)d.includes(g)||d.push(g)}for(const g of d)if(g.ownedBy){f=g.convexHull;for(p=0;p<f.length;p+=2)mat4.fromTranslation(c,[g.viewport.x,g.viewport.y,0]),mat4.mul(c,c,g.viewport.userMat),mat4.scale(c,c,[g.viewport.getScale(),g.viewport.getScale(),1]),mat4.translate(c,c,[g.x+f[p+0]-g.viewport.userX,g.y+f[p+1]-g.viewport.userY,0]),mat4.scale(c,c,[f[(p+2)%f.length]-f[p+
0],f[(p+3)%f.length]-f[p+1],1]),k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,z.unitLine,E.unitLine);f=vec3.create();mat4.getScaling(f,g.viewport.userMat)}for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[g.x,g.y,0]),k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c),"mouse"==g.e.pointerType?k.drawArrays(k.LINE_LOOP,z.roundMouse,E.roundMouse):k.drawArrays(k.LINE_LOOP,z.roundTouch,E.roundTouch)}na=(na+1)%16;mat4.identity(c);
mat4.translate(c,c,[160,45,0]);mat4.rotate(c,c,Math.PI/8*na,[0,0,1]);mat4.scale(c,c,[40,10,0]);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,10,0]);mat4.scale(c,c,[50,10,0]);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,25,0]);mat4.scale(c,c,[50*window.visualViewport.scale,
10,0]);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,40,0]);mat4.scale(c,c,[50*window.devicePixelRatio,10,0]);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,55,0]);mat4.scale(c,c,[50*window.innerWidth/1E3,10,0]);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),
!1,c);k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[12,57,0]),mat4.scale(c,c,[46*g.x/D/1E3,6,0]),k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,70,0]);mat4.scale(c,c,[50*window.innerHeight/1E3,10,0]);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare);
for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[12,72,0]),mat4.scale(c,c,[46*g.y/D/1E3,6,0]),k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,z.unitSquare,E.unitSquare)}}}window.requestAnimationFrame(ya)}function V(){ka=10;var a;if(oa&&pa){var c=oa;var d=pa;var f=a=1;w.width=c;w.height=d}else c=window.innerWidth,d=window.innerHeight,a=window.devicePixelRatio,f=window.visualViewport.scale,w.width=c*f*a,w.height=d*f*a;w.style.width=
`${c}px`;w.style.height=`${d}px`;za=Math.sqrt(w.width*w.width+w.height*w.height);D=f*a;ja=!0;x.resizeFunc&&x.resizeFunc.call(x)}function K(a,c){function d(n,q){for(const r of n.hitList.hits)r.gad!==q&&r.gad.ownedBy==g&&(r.gad.gestureState+="-disowned",r.gad.viewport.setRenderFlag(!0),delete r.gad.ownedBy)}function f(n){const q=n.x-n.ox;n=n.y-n.oy;return q*q>n*n?0<q?"right":"left":0<n?"down":"up"}if("touches"==c&&a.touches&&0==a.touches.length){a=[];for(var [,b]of Object.entries(u))b.tempIsActive=
...
var h=G.createBufferSource();G.createScriptProcessor(2048);h.start();e=2}else 2==e&&(h=new AudioWorkletNode(G,"audio-processor"),h.connect(G.destination),ra=h.parameters.get("click"),P=h.parameters.get("beep"),ma=h.parameters.get("windspeed"),e=3,g=!0)}if(k){var f=k.createShader(k.VERTEX_SHADER);k.shaderSource(f,"\n        attribute vec4 aVertexPosition;\n        uniform vec4 uVertexColor;\n        uniform mat4 uModelViewMatrix;\n        uniform mat4 uProjectionMatrix;\n        varying vec4 v_Color;\n        void main() {\n          gl_Position = uProjectionMatrix * uModelViewMatrix * aVertexPosition;\n          v_Color = uVertexColor;\n        }\n\t");
k.compileShader(f);if(k.getShaderParameter(f,k.COMPILE_STATUS)){var b=k.createShader(k.FRAGMENT_SHADER);k.shaderSource(b,"\n        varying lowp vec4 v_Color;\n        void main() {\n          gl_FragColor = v_Color;\n        }\n\t");k.compileShader(b);if(k.getShaderParameter(b,k.COMPILE_STATUS)&&(A=k.createProgram(),k.attachShader(A,f),k.attachShader(A,b),k.linkProgram(A),k.getProgramParameter(A,k.LINK_STATUS))){ia=k.createBuffer();k.bindBuffer(k.ARRAY_BUFFER,ia);k.vertexAttribPointer(k.getAttribLocation(A,
"aVertexPosition"),2,k.FLOAT,!1,0,0);k.enableVertexAttribArray(k.getAttribLocation(A,"aVertexPosition"));f=[];z.unitLine=f.length/2;f.splice(f.length,0,0,0,1,1);E.unitLine=f.length/2-z.unitLine;z.unitSquare=f.length/2;f.splice(f.length,0,1,1,0,1,0,0,1,0);E.unitSquare=f.length/2-z.unitSquare;z.roundTouch=f.length/2;for(b=0;36>b;b++)f.splice(f.length,0,85*Math.sin(b/18*Math.PI),85*Math.cos(b/18*Math.PI));E.roundTouch=f.length/2-z.roundTouch;z.squareTouch=f.length/2;f.splice(f.length,0,84.5,84.5,-84.5,
84.5,-84.5,-84.5,84.5,-84.5);E.squareTouch=f.length/2-z.squareTouch;z.roundMouse=f.length/2;for(b=0;36>b;b++)f.splice(f.length,0,5*Math.sin(b/18*Math.PI),5*Math.cos(b/18*Math.PI));E.roundMouse=f.length/2-z.roundMouse;z.squareMouse=f.length/2;f.splice(f.length,0,4.5,4.5,-4.5,4.5,-4.5,-4.5,4.5,-4.5);E.squareMouse=f.length/2-z.squareMouse;k.bufferData(k.ARRAY_BUFFER,new Float32Array(f),k.STATIC_DRAW);var g=!1,e=0;a&&(x=a);c&&(window.addEventListener("resize",function(h){V()},!1),V(),window.requestAnimationFrame(ya),
...
T;l&&l.pasteFunc&&l.pasteFunc.call(l,h)}),document.addEventListener("keydown",function(h){var l=T;l&&l.keydownFunc&&l.keydownFunc.call(l,h)}))}}}}let m;var w,oa,pa,ba,aa,fa,ha,k;const z={},E={};var G,ra,P,ma,ia,za,D,ja;const C=[];const O=mat4.create();var qa=0,A,T,J,sa,ta,ua,va,wa;class Ea{constructor(a,c){this.x=a;this.y=c;this.hits=[]}sortHits(){for(var a=[];0<this.hits.length;){var c=0,d=this.hits[0].dist,f,b=this.hits[0].gad.z?this.hits[0].gad.z:0,g;for(f=0;f<this.hits.length&&(g=this.hits[f].gad.z?
...
this.setPoint[this.stateNew])),-1===C.indexOf(this)&&C.push(this)):(this.stateProg-=.008*h,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===C.indexOf(this)&&C.push(this));h="v"==this.state?"h":"v";this.setPoint&&h in this.setPoint&&(e=this.setPoint[h])}this.layoutFunc&&this.state!=g&&this.layoutFunc.call(this);g=Math.min(Math.max(this.ratio,this.ratioMin[this.state]),this.ratioMax[this.state]);g!=this.ratio&&(this.ratio=g,-1===C.indexOf(this)&&C.push(this));g=1-this.stateProg*(1-e);e=1-
...
this.c.layoutAll(f);this.layoutEndFunc&&this.layoutEndFunc.call(this);g=Math.min(Math.max(this.ratio,this.ratioMin[this.state]),this.ratioMax[this.state]);g!=this.ratio&&(this.ratio=g,-1===C.indexOf(this)&&C.push(this))}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll();this.c&&(this.c.needsRender||this.c.childRender)&&this.c.renderAll()}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&
this.b.getHits(a,c);this.c&&this.c.getHits(a,c)}}class Ga extends U{constructor(a){super(a);this.b=this.a=void 0}layoutAll(a){super.layoutAll(a);this.layoutFunc&&this.layoutFunc.call(this);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);c.remainingX=a.remainingX;c.remainingY=a.remainingY;c.remainingWidth=a.remainingWidth;c.remainingHeight=a.remainingHeight;d.remainingX=a.remainingX;d.remainingY=a.remainingY;d.remainingWidth=a.remainingWidth;d.remainingHeight=a.remainingHeight;
this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}setRenderFlag(a){super.setRenderFlag(!0)}renderAll(){super.renderAll();if(this.a&&(this.a.needsRender||this.a.childRender)||this.b&&(this.b.needsRender||this.b.childRender)){this.b.renderAll();this.clip();var a=this.ghostOpacity||.5;if(0<a||this.ghostColor?.[3]){let c=this.ghostColor;!c&&this.b?.bgColor&&(c=[this.b.bgColor[0],this.b.bgColor[1],this.b.bgColor[2],a]);xa();k.enable(k.BLEND);k.uniform4fv(k.getUniformLocation(A,"uVertexColor"),new Float32Array(c||
[.5,.5,.5,a]));a=mat4.create();mat4.identity(a);k.uniformMatrix4fv(k.getUniformLocation(A,"uModelViewMatrix"),!1,a);k.drawArrays(k.TRIANGLE_FAN,z.unitSquare,E.unitSquare)}this.a.renderAll(!1)}}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ha extends U{constructor(a,c,d,f){super(a);this.type=c;this.stateNew=this.state="";this.stateProg=0;this.sizeH=d;this.sizeV=f?f:d;this.prop=!1;this.threshold=.5;this.b=this.a=void 0;this.prevTime=0;this.tallState=this.wideState="";"t l r b tl tr bl br".split(" ").includes(this.type)||
console.error("Warning: Invalid 'type' for SliceView.")}layoutAll(a){super.layoutAll(a);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){var f=~~(this.sizeH*(this.prop?this.w:this.getScale())),b=~~(this.sizeV*(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)?!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):
"tr"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;this.state=this.stateNew}if(1<this.type.length){e=0;var h=Date.now();0!=this.prevTime&&(e=h-this.prevTime);this.prevTime=h;17<e&&(e=17);a.remainingWidth*this.threshold>a.remainingHeight*
(1-this.threshold)+2&&(this.stateNew=this.wideState);a.remainingHeight*this.threshold>a.remainingWidth*(1-this.threshold)+2&&(this.stateNew=this.tallState);if(this.stateNew!=this.state||0<this.stateProg)this.stateNew!=this.state?(this.stateProg+=.008*e,1<=this.stateProg&&(this.stateProg=1,this.state=this.stateNew),-1===C.indexOf(this)&&C.push(this)):(this.stateProg-=.008*e,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===C.indexOf(this)&&C.push(this))}this.layoutFunc&&this.state!=g&&0<
...
this.layoutPageFunc);g&&(n.pageBlurFunc&&n.pageBlurFunc(),e.pageFocusFunc&&e.pageFocusFunc());h=Math.round(h*this.viewScale);l=Math.round(l*this.viewScale);c.remainingWidth=Math.min(Math.max(a.remainingWidth-Math.abs(h),0),a.remainingWidth);c.remainingHeight=Math.min(Math.max(a.remainingHeight-Math.abs(l),0),a.remainingHeight);c.remainingX=Math.min(Math.max(a.remainingX-(0>h?h:0),a.remainingX),a.remainingX+a.remainingWidth);c.remainingY=Math.min(Math.max(a.remainingY-(0>l?l:0),a.remainingY),a.remainingY+
a.remainingHeight);n?f?(d.remainingWidth=a.remainingWidth-c.remainingWidth,d.remainingHeight=a.remainingHeight,d.remainingX=a.remainingX,d.remainingY=a.remainingY,c.remainingX==a.remainingX&&(d.remainingX+=c.remainingWidth)):b&&(d.remainingWidth=a.remainingWidth,d.remainingHeight=a.remainingHeight-c.remainingHeight,d.remainingX=a.remainingX,d.remainingY=a.remainingY,c.remainingY==a.remainingY&&(d.remainingY+=c.remainingHeight)):d.clear()}else c.clear(),d.clear();this.a&&this.a.layoutAll(c);this.b&&
this.b.layoutAll(d)}}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){super.getHits(a,c);this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ja extends U{constructor(a,c,d,f){super(a);this.type=c;this.stateNew=this.state="";this.stateProg=0;this.sizeH=d;this.sizeV=f?f:d;this.prop=!1;this.threshold=.5;this.b=this.a=void 0;this.prevTime=0;this.tallState=this.wideState=
""}layoutAll(a){super.layoutAll(a);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){var f=~~(this.sizeH*(this.prop?this.w:this.getScale())),b=~~(this.sizeV*(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)?!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"tr"==this.type?(this.wideState="r",this.tallState=
"t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;this.state=this.stateNew}if(1<this.type.length){e=0;var h=Date.now();0!=this.prevTime&&(e=h-this.prevTime);this.prevTime=h;17<e&&(e=17);a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)+2&&(this.stateNew=
this.wideState);a.remainingHeight*this.threshold>a.remainingWidth*(1-this.threshold)+2&&(this.stateNew=this.tallState);if(this.stateNew!=this.state||0<this.stateProg)this.stateNew!=this.state?(this.stateProg+=.008*e,1<=this.stateProg&&(this.stateProg=1,this.state=this.stateNew),-1===C.indexOf(this)&&C.push(this)):(this.stateProg-=.008*e,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===C.indexOf(this)&&C.push(this))}this.layoutFunc&&this.state!=g&&0<this.w&&0<this.h&&this.layoutFunc.call(this);
...
0!=this.convexHull.length){var d=this.viewport,f=vec3.create();mat4.getScaling(f,d.userMat);c=c/d.getScale()/f[0];f=""+c;f in this.extendedHulls||(this.computeExtendedHull(c),this.computeBoundingBox(c));c=this.extendedHulls[f];var b=this.boundingBoxes[f],g=1/d.getScale();f=vec3.create();f[0]=a.x-d.x-this.x/g;f[1]=a.y-d.y-this.y/g;var e=mat4.create();mat4.invert(e,d.userMat);vec3.transformMat4(f,f,e);f=(a.x-d.x-d.ox)*g+d.userX-this.x-this.xo;d=(a.y-d.y-d.oy)*g+d.userY-this.y-this.yo;if(!(f<b.x1||f>=
b.x2||d<b.y1||d>=b.y2)){g=c.length;b=!0;for(e=0;e<g;e+=2){var h=c[e+0];var l=c[e+1];h=(c[(e+2)%g]-h)*(d-l)-(c[(e+3)%g]-l)*(f-h);0>h&&(b=!1)}if(b){g=this.convexHull.length;b=!0;for(e=0;e<g;e+=2)c=this.convexHull[e+0],h=this.convexHull[e+1],h=(this.convexHull[(e+2)%g]-c)*(d-h)-(this.convexHull[(e+3)%g]-h)*(f-c),0>h&&(b=!1);c=0;b||(c=this.distToHull(f,d));a.hits.push({gad:this,dist:c})}}}}autoHull(){this.convexHull=this.computeHull([0,0,this.w,0,this.w,this.h,0,this.h]);this.extendedHulls={};this.boundingBoxes=
{}}computeHull(a){function c(t,v,B,F,L,M){return(B-t)*(M-v)-(F-v)*(L-t)}function d(t){return t*t}function f(t,v,B,F,L,M){var H=d(B-L)+d(F-M);if(0==H)return d(t-B)+d(v-F);H=Math.max(0,Math.min(1,((t-B)*(L-B)+(v-F)*(M-F))/H));F+=H*(M-F);return d(t-(B+H*(L-B)))+d(v-F)}function b(t,v,B,F,L,M){if(!(2>v.length)){for(var H=0,R=0,y=0;y<~~(v.length/2);y++){var S=Math.sqrt(f(v[2*y],v[2*y+1],B,F,L,M));S>R&&(R=S,H=y)}R=v[2*H];S=v[2*H+1];v.splice(2*H,2);for(y=0;y<~~(t.length/2);y++)if(t[2*y]==B&&t[2*y+1]==F&&
t[(2*y+2)%t.length]==L&&t[(2*y+3)%t.length]==M||t[2*y]==L&&t[2*y+1]==M&&t[(2*y+2)%t.length]==B&&t[(2*y+3)%t.length]==F){t.splice(2*y+2,0,R,S);break}H=[];var Y=[];for(y=0;y<~~(v.length/2);y++)0>c(B,F,R,S,v[2*y],v[2*y+1])&&(H[H.length]=v[2*y],H[H.length]=v[2*y+1]),0>c(R,S,L,M,v[2*y],v[2*y+1])&&(Y[Y.length]=v[2*y],Y[Y.length]=v[2*y+1]);b(t,H,B,F,R,S);b(t,Y,R,S,L,M)}}for(var g=[...a],e=[],h=0,l=0,n=g[0],q=g[0],r=0;r<~~(g.length/2);r++)g[2*r]<n&&(n=g[2*r],h=r),g[2*r]>q&&(q=g[2*r],l=r);e[e.length]=g[2*
h];e[e.length]=g[2*h+1];e[e.length]=g[2*l];e[e.length]=g[2*l+1];g.splice(2*h,2);l<h?g.splice(2*l,2):g.splice(2*l-2,2);n=[];q=[];for(r=0;r<~~(g.length/2);r++)0>c(a[2*h],a[2*h+1],a[2*l],a[2*l+1],g[2*r],g[2*r+1])?(n[n.length]=g[2*r],n[n.length]=g[2*r+1]):(q[q.length]=g[2*r],q[q.length]=g[2*r+1]);b(e,n,a[2*h],a[2*h+1],a[2*l],a[2*l+1]);b(e,q,a[2*l],a[2*l+1],a[2*h],a[2*h+1]);for(a=1;a;)for(r=a=0;r<~~(e.length/2);r++)if(.01>Math.sqrt(f(e[(2*r+2)%e.length],e[(2*r+3)%e.length],e[2*r],e[2*r+1],e[(2*r+4)%e.length],
e[(2*r+5)%e.length]))){e.splice(2*r+2,2);a=1;break}return this.sortHull(e)}sortHull(a){function c(q){for(q=Math.atan2(a[q+1]-b,a[q+0]-f)-Math.atan2(l-b,h-f);q>Math.PI;)q-=2*Math.PI;for(;q<-Math.PI;)q+=2*Math.PI;return q}for(var d=[],f=0,b=0,g=a.length,e=0;e<g;e+=2)f+=a[e+0],b+=a[e+1];f/=g/2;b/=g/2;for(var h=f+102,l=b+1;0<a.length;){g=0;var n=c(0);for(e=0;e<a.length;e+=2)c(e)<n&&(g=e,n=c(e));d.push(a[g+0]);d.push(a[g+1]);a.splice(g,2)}return d}computeExtendedHull(a){for(var c=[],d=0,f=this.convexHull.length,
b=0;b<f;b+=2){var g=this.convexHull[(b+3)%f]-this.convexHull[b+1],e=-(this.convexHull[(b+2)%f]-this.convexHull[b+0]),h=a/Math.sqrt(g*g+e*e);c[d+0]=this.convexHull[b+0]+g*h;c[d+1]=this.convexHull[b+1]+e*h;d+=2;c[d+0]=this.convexHull[(b+2)%f]+g*h;c[d+1]=this.convexHull[(b+3)%f]+e*h;d+=2}for(b=0;b<f;b+=2){g=this.convexHull[(b+2)%f]-this.convexHull[b+0];e=this.convexHull[(b+3)%f]-this.convexHull[b+1];d=this.convexHull[(b-2+f)%f]-this.convexHull[b+0];var l=this.convexHull[(b-1+f)%f]-this.convexHull[b+
1];h=Math.sqrt(g*g+e*e);l=Math.tan((Math.PI-Math.acos((g*d+e*l)/(h*Math.sqrt(d*d+l*l))))/4)*a;d=2*b;g=c[d+0]-c[d+2];e=c[d+1]-c[d+3];h=Math.sqrt(g*g+e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+0]=g+c[d+2];c[d+1]=e+c[d+3];d=(b-2+f)%f*2;g=c[d+2]-c[d+0];e=c[d+3]-c[d+1];h=Math.sqrt(g*g+e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+2]=g+c[d+0];c[d+3]=e+c[d+1]}this.extendedHulls[""+a]=c}computeBoundingBox(a){this.boundingBoxes[""+a]={};var c=this.extendedHulls[""+a];a=this.boundingBoxes[""+a];if(!(2>c.length)){a.x1=c[0];a.x2=c[0];
a.y1=c[1];a.y2=c[1];for(var d=2;d<c.length;d+=2)c[d+0]<a.x1&&(a.x1=c[d+0]),c[d+0]>a.x2&&(a.x2=c[d+0]),c[d+1]<a.y1&&(a.y1=c[d+1]),c[d+1]>a.y2&&(a.y2=c[d+1])}}distToHull(a,c){function d(l){return l*l}function f(l,n,q,r,t,v){var B=d(q-t)+d(r-v);if(0==B)return d(l-q)+d(n-r);B=Math.max(0,Math.min(1,((l-q)*(t-q)+(n-r)*(v-r))/B));r+=B*(v-r);return d(l-(q+B*(t-q)))+d(n-r)}for(var b=this.convexHull,g=Math.sqrt(f(a,c,b[0],b[1],b[2],b[3])),e=2;e<b.length;e+=2){var h=Math.sqrt(f(a,c,b[e+0],b[e+1],b[(e+2)%b.length],
b[(e+3)%b.length]));h<g&&(g=h)}return g}}class Ka extends X{constructor(a){super(a);this.dragBeginFunc=function(c){this.tempX=c.ox-this.viewport.x;this.tempY=c.oy-this.viewport.y};this.dragMoveFunc=function(c){var d=this.viewport.parent,f="h"==d.state,b=f?c.y-this.tempY-d.a.y:c.x-this.tempX-d.a.x;d.ratio=Math.max(0,Math.min(1,b/(b+(f?d.y+d.h-(c.y-this.tempY+this.viewport.h):d.x+d.w-(c.x-this.tempX+this.viewport.w)))));d.setPoint||(d.setPoint={});d.setPoint[d.state]=d.ratio;-1===C.indexOf(this.viewport.parent)&&
C.push(this.viewport.parent)};this.dragEndFunc=function(c){delete this.tempX;delete this.tempY}}layout(){var a=this.viewport,c=a.getScale(),d=a.parent.size,f="h"==a.parent.state;var b=f?Math.max(1,a.w)/c:d;a=f?d:Math.max(1,a.h)/c;this.actionFlags=f?m.GAF_DRAGGABLE_UPDOWN:m.GAF_DRAGGABLE_LEFTRIGHT;this.convexHull=this.computeHull([0,0,0,a,b,a,b,0]);this.extendedHulls={};this.boundingBoxes={}}}class La extends X{getTargetMat(){return this.targetGad?this.targetGad.mat:this.targetView.userMat}constructor(a){super(a);
...
1,0,0,1,0,1,1]),k.STATIC_DRAW);ta=k.getAttribLocation(J,"aVertex");ua=k.getAttribLocation(J,"aUV");k.getUniformLocation(J,"pos")}sa=k.createTexture();k.bindTexture(k.TEXTURE_2D,sa);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_MIN_FILTER,k.LINEAR);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_MAG_FILTER,k.LINEAR);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE);k.texImage2D(k.TEXTURE_2D,0,k.RGBA,k.RGBA,k.UNSIGNED_BYTE,a);return sa},drawImage:function(a,
c,d){k.useProgram(J);k.enableVertexAttribArray(ta);k.bindBuffer(k.ARRAY_BUFFER,va);k.vertexAttribPointer(ta,2,k.FLOAT,!1,0,0);k.enableVertexAttribArray(ua);k.bindBuffer(k.ARRAY_BUFFER,wa);k.bindTexture(k.TEXTURE_2D,a);k.vertexAttribPointer(ua,2,k.FLOAT,!1,0,0);k.uniformMatrix4fv(k.getUniformLocation(J,"pm"),!1,c);k.uniformMatrix4fv(k.getUniformLocation(J,"mm"),!1,d);k.drawArrays(k.TRIANGLE_FAN,0,4)},beep:function(a=""){if(P)switch(a){case "qr-scan":P.setValueAtTime(2,G.currentTime);P.setValueAtTime(3,
...
m.GAF_BACKNAV&&a.clickFunc&&a.clickFunc.call(a,void 0)},View:U,DividerView:Fa,SliceView:Ha,PagesView:Ia,PopupView:Ja,OverlayView:Ga,ViewPicker:Da,Gadget:X,MatrixGadget:La,SwipeGadget:Ma,MiddleDividerGadget:Ka,GAF_CLICKABLE:1,GAF_HOLDABLE:2,GAF_CONTEXTMENU:4,GAF_STRETCHABLE:8,GAF_DRAGGABLE_UPDOWN:16,GAF_DRAGGABLE_LEFTRIGHT:32,GAF_DRAGGABLE:48,GAF_SWIPEABLE_UPDOWN:64,GAF_SWIPEABLE_LEFTRIGHT:128,GAF_SWIPEABLE:192,GAF_SCROLLABLE_UPDOWN:256,GAF_SCROLLABLE_LEFTRIGHT:512,GAF_SCROLLABLE:768,GAF_SCALABLE:1024,
GAF_ROTATABLE:2048,GAF_PINCHABLE:3072,GAF_NUMINPUT:4096,GAF_TEXTINPUT:8192,GAF_GONEXT:16384,GAF_BACKNAV:32768,GAF_ALL:3901,HitList:Ea,LayoutState:I}}();
