...
this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}setRenderFlag(a){super.setRenderFlag(!0)}renderAll(){super.renderAll();if(this.a&&(this.a.needsRender||this.a.childRender)||this.b&&(this.b.needsRender||this.b.childRender)){this.b.renderAll();const a=this.ghostOpacity||.5;if(0<a||this.ghostColor?.[3]){let c=this.ghostColor;!c&&this.b?.bgColor&&(c=[this.b.bgColor[0],this.b.bgColor[1],this.b.bgColor[2],a]);k.clearColor(...(c||[.5,.5,.5,a]));k.clear(k.COLOR_BUFFER_BIT)}this.a.renderAll(!1)}}getHits(a,
