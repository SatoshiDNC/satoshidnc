...
c.focus(),c.select())}function xa(){k.useProgram(z);k.bindBuffer(k.ARRAY_BUFFER,ia);var a=k.getAttribLocation(z,"aVertexPosition");k.vertexAttribPointer(a,2,k.FLOAT,!1,0,0);k.enableVertexAttribArray(a)}function ya(a){if(a!=ca){var c=0;0<ca&&(c=a-ca);ca=a;const b=[];for(;a=C.pop();)b.push(a);if(ja)ja=!1,k.viewport(0,0,w.width,w.height),mat4.identity(O),mat4.translate(O,O,[-1,1,0]),mat4.scale(O,O,[2/w.width,-2/w.height,1]),x&&(a=new m.LayoutState(w.width,w.height),x.layoutAll(a));else for(;a=b.pop();)a.relayout();
ka&&(--ka||x.setRenderFlag(!0));la&&x.setRenderFlag(!0);if(x&&(x.needsRender||x.childRender)){a=0;for(var [,d]of Object.entries(u))d.dx=(d.x-d.px)/c,d.px=d.x,d.dy=(d.y-d.py)/c,d.py=d.y,a+=Math.sqrt(d.dx*d.dx+d.dy*d.dy)/za;ma&&ma.setValueAtTime(a,G.currentTime);x.renderAll();if(Aa){k.viewport(0,0,w.width,w.height);k.disable(k.SCISSOR_TEST);xa();k.enable(k.BLEND);k.uniform4fv(k.getUniformLocation(z,"uVertexColor"),new Float32Array([1,1,1,1]));k.uniformMatrix4fv(k.getUniformLocation(z,"uProjectionMatrix"),
...
0],f[(p+3)%f.length]-f[p+1],1]),k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,A.unitLine,E.unitLine);f=vec3.create();mat4.getScaling(f,g.viewport.userMat)}for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[g.x,g.y,0]),k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c),"mouse"==g.e.pointerType?k.drawArrays(k.LINE_LOOP,A.roundMouse,E.roundMouse):k.drawArrays(k.LINE_LOOP,A.roundTouch,E.roundTouch)}na=(na+1)%16;mat4.identity(c);
mat4.translate(c,c,[160,45,0]);mat4.rotate(c,c,Math.PI/8*na,[0,0,1]);mat4.scale(c,c,[40,10,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,10,0]);mat4.scale(c,c,[50,10,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,25,0]);mat4.scale(c,c,[50*window.visualViewport.scale,
10,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,40,0]);mat4.scale(c,c,[50*window.devicePixelRatio,10,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,55,0]);mat4.scale(c,c,[50*window.innerWidth/1E3,10,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),
!1,c);k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[12,57,0]),mat4.scale(c,c,[46*g.x/D/1E3,6,0]),k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);mat4.identity(c);mat4.translate(c,c,[10,70,0]);mat4.scale(c,c,[50*window.innerHeight/1E3,10,0]);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c);k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare);
for(const [,g]of Object.entries(u))mat4.identity(c),mat4.translate(c,c,[12,72,0]),mat4.scale(c,c,[46*g.y/D/1E3,6,0]),k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,c),k.drawArrays(k.LINE_LOOP,A.unitSquare,E.unitSquare)}}}window.requestAnimationFrame(ya)}function V(){ka=10;var a;if(oa&&pa){var c=oa;var d=pa;var f=a=1;w.width=c;w.height=d}else c=window.innerWidth,d=window.innerHeight,a=window.devicePixelRatio,f=window.visualViewport.scale,w.width=c*f*a,w.height=d*f*a;w.style.width=
...
k.compileShader(f);if(k.getShaderParameter(f,k.COMPILE_STATUS)){var b=k.createShader(k.FRAGMENT_SHADER);k.shaderSource(b,"\n        varying lowp vec4 v_Color;\n        void main() {\n          gl_FragColor = v_Color;\n        }\n\t");k.compileShader(b);if(k.getShaderParameter(b,k.COMPILE_STATUS)&&(z=k.createProgram(),k.attachShader(z,f),k.attachShader(z,b),k.linkProgram(z),k.getProgramParameter(z,k.LINK_STATUS))){ia=k.createBuffer();k.bindBuffer(k.ARRAY_BUFFER,ia);k.vertexAttribPointer(k.getAttribLocation(z,
"aVertexPosition"),2,k.FLOAT,!1,0,0);k.enableVertexAttribArray(k.getAttribLocation(z,"aVertexPosition"));f=[];A.unitLine=f.length/2;f.splice(f.length,0,0,0,1,1);E.unitLine=f.length/2-A.unitLine;A.unitSquare=f.length/2;f.splice(f.length,0,1,1,0,1,0,0,1,0);E.unitSquare=f.length/2-A.unitSquare;A.roundTouch=f.length/2;for(b=0;36>b;b++)f.splice(f.length,0,85*Math.sin(b/18*Math.PI),85*Math.cos(b/18*Math.PI));E.roundTouch=f.length/2-A.roundTouch;A.squareTouch=f.length/2;f.splice(f.length,0,84.5,84.5,-84.5,
84.5,-84.5,-84.5,84.5,-84.5);E.squareTouch=f.length/2-A.squareTouch;A.roundMouse=f.length/2;for(b=0;36>b;b++)f.splice(f.length,0,5*Math.sin(b/18*Math.PI),5*Math.cos(b/18*Math.PI));E.roundMouse=f.length/2-A.roundMouse;A.squareMouse=f.length/2;f.splice(f.length,0,4.5,4.5,-4.5,4.5,-4.5,-4.5,4.5,-4.5);E.squareMouse=f.length/2-A.squareMouse;k.bufferData(k.ARRAY_BUFFER,new Float32Array(f),k.STATIC_DRAW);var g=!1,e=0;a&&(x=a);c&&(window.addEventListener("resize",function(h){V()},!1),V(),window.requestAnimationFrame(ya),
...
T;l&&l.pasteFunc&&l.pasteFunc.call(l,h)}),document.addEventListener("keydown",function(h){var l=T;l&&l.keydownFunc&&l.keydownFunc.call(l,h)}))}}}}let m;var w,oa,pa,ba,aa,fa,ha,k;const A={},E={};var G,ra,P,ma,ia,za,D,ja;const C=[];const O=mat4.create();var qa=0,z,T,J,sa,ta,ua,va,wa;class Ea{constructor(a,c){this.x=a;this.y=c;this.hits=[]}sortHits(){for(var a=[];0<this.hits.length;){var c=0,d=this.hits[0].dist,f,b=this.hits[0].gad.z?this.hits[0].gad.z:0,g;for(f=0;f<this.hits.length&&(g=this.hits[f].gad.z?
...
this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}setRenderFlag(a){super.setRenderFlag(!0)}renderAll(){super.renderAll();if(this.a&&(this.a.needsRender||this.a.childRender)||this.b&&(this.b.needsRender||this.b.childRender)){this.b.renderAll();this.clip();var a=this.ghostOpacity||.5;if(0<a||this.ghostColor?.[3]){let c=this.ghostColor;!c&&this.b?.bgColor&&(c=[this.b.bgColor[0],this.b.bgColor[1],this.b.bgColor[2],a]);xa();k.enable(k.BLEND);k.uniform4fv(k.getUniformLocation(z,"uVertexColor"),new Float32Array(c||
[.5,.5,.5,a]));a=mat4.create();mat4.identity(a);k.uniformMatrix4fv(k.getUniformLocation(z,"uProjectionMatrix"),!1,a);k.uniformMatrix4fv(k.getUniformLocation(z,"uModelViewMatrix"),!1,a);k.drawArrays(k.TRIANGLE_FAN,A.unitSquare,E.unitSquare)}this.a.renderAll(!1)}}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ha extends U{constructor(a,c,d,f){super(a);this.type=c;this.stateNew=this.state="";this.stateProg=0;this.sizeH=d;this.sizeV=f?f:d;this.prop=!1;this.threshold=.5;this.b=
this.a=void 0;this.prevTime=0;this.tallState=this.wideState="";"t l r b tl tr bl br".split(" ").includes(this.type)||console.error("Warning: Invalid 'type' for SliceView.")}layoutAll(a){super.layoutAll(a);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){var f=~~(this.sizeH*(this.prop?this.w:this.getScale())),b=~~(this.sizeV*(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=a.remainingWidth*this.threshold>a.remainingHeight*(1-
this.threshold)?!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"tr"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;this.state=this.stateNew}if(1<this.type.length){e=
0;var h=Date.now();0!=this.prevTime&&(e=h-this.prevTime);this.prevTime=h;17<e&&(e=17);a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)+2&&(this.stateNew=this.wideState);a.remainingHeight*this.threshold>a.remainingWidth*(1-this.threshold)+2&&(this.stateNew=this.tallState);if(this.stateNew!=this.state||0<this.stateProg)this.stateNew!=this.state?(this.stateProg+=.008*e,1<=this.stateProg&&(this.stateProg=1,this.state=this.stateNew),-1===C.indexOf(this)&&C.push(this)):(this.stateProg-=
.008*e,0>this.stateProg&&(this.stateProg=0),0<this.stateProg&&-1===C.indexOf(this)&&C.push(this))}this.layoutFunc&&this.state!=g&&0<this.w&&0<this.h&&this.layoutFunc.call(this);e="t"==this.state||"b"==this.state?b/a.remainingWidth:f/a.remainingHeight;g=1-this.stateProg*(1-e);e=1-this.stateProg*(0+e);"l"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=~~(a.remainingHeight*e),d.remainingX=a.remainingX+
b,"t"==this.tallState?(c.remainingY=a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"r"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX+a.remainingWidth-b,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=~~(a.remainingHeight*e),d.remainingX=a.remainingX,"t"==this.tallState?(c.remainingY=a.remainingY,d.remainingY=a.remainingY+
a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"t"==this.state?(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY+f,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,
d.remainingX=a.remainingX)):"b"==this.state&&(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY+a.remainingHeight-f,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX))}else c.clear(),d.clear();this.a&&this.a.layoutAll(c);
this.b&&this.b.layoutAll(d)}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ia extends U{constructor(a,c){super(a);this.type=c;this.indexProg=this.indexNew=this.index=0;this.b=this.a=void 0;this.pages=[];this.snaps=[];this.prevTime=0;this.keepPageFlag=!1;this.gadgets.push(this.swipeGad=new m.SwipeGadget(this));
switch(this.type){case "h":this.swipeGad.actionFlags=m.GAF_SWIPEABLE_LEFTRIGHT|m.GAF_SCROLLABLE_LEFTRIGHT;break;case "v":this.swipeGad.actionFlags=m.GAF_SWIPEABLE_UPDOWN|m.GAF_SCROLLABLE_UPDOWN;break;default:this.swipeGad.actionFlags=0}this.layoutFunc=function(){0!=this.pages.length&&(this.minX=0,this.maxX=this.sw*this.pages.length,this.minY=0,this.maxY=this.sh*this.pages.length,this.swipeGad.layout.call(this.swipeGad))};this.layoutPageFunc=function(){this.sw=this.parent.sw;this.sh=this.parent.sh;
this.layoutFunc_&&this.layoutFunc_()};this.toPage=function(d){var f=this.swipeGad;d=Math.min(Math.max(d,0),this.pages.length);d>this.index?f.doSwipe(!0,d):d<this.index&&f.doSwipe(!1,d)}}keepPage(){this.keepPageFlag=!0}getPageIndex(a){for(var c=0;c<this.pages.length;c++)if(this.pages[c]===a)return c;return-1}getPageOffset(a){return"h"==this.type?this.userX-a*this.sw:this.userY-a*this.sh}layoutAll(a){super.layoutAll(a);if(0!=this.pages.length){var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,
a.totalHeight);if(a.hasArea()){this.prevTime=Date.now();var f="h"==this.type,b="v"==this.type;this.snaps=[];for(var g=0;g<this.pages.length;g++)this.snaps.push([this.sw*g*(f?1:0),this.sh*g*(b?1:0)]);if(this.viewScale!=this.prevScale||this.keepPageFlag)this.userX=this.index*this.sw,this.prevScale=this.viewScale,this.keepPageFlag=!1;var e=this.index;g=!1;f&&(this.index=Math.min(Math.max(Math.round(this.userX/this.sw),0),this.pages.length-1));b&&(this.index=Math.min(Math.max(Math.round(this.userY/this.sh),
0),this.pages.length-1));this.index!=e&&this.pageChangeFunc&&(g=!0,this.pageChangeFunc.call(this));e=this.pages[this.index];var h=this.userX+(f?-this.index*this.sw:0),l=this.userY+(b?-this.index*this.sh:0),n=void 0;if(f&&this.index*this.sw>this.userX||b&&this.index*this.sh>this.userY){f&&(e.userX=0);b&&(e.userY=0);var q=this.index-1;if(0<=q&&q<this.pages.length){n=this.pages[q];q=this.userX+(f?-this.index*this.sw+this.sw:0);var r=this.userY+(b?-this.index*this.sh+this.sh:0);f&&(n.userX=f?q*this.viewScale/
n.viewScale:0);b&&(n.userY=b?r*this.viewScale/n.viewScale:0)}}else f&&this.index*this.sw<this.userX||b&&this.index*this.sh<this.userY?(f&&(e.userX=f?h*this.viewScale/e.viewScale:0),b&&(e.userY=b?l*this.viewScale/e.viewScale:0),q=this.index+1,0<=q&&q<this.pages.length&&(n=this.pages[q],f&&(n.userX=0),b&&(n.userY=0))):(f&&(e.userX=0),b&&(e.userY=0));this.a=e;e.parent=this;if(this.b=n)n.parent=this;this.a&&this.a.layoutFunc!==this.layoutPageFunc&&(this.a.layoutFunc&&(this.a.layoutFunc_=this.a.layoutFunc),
this.a.layoutFunc=this.layoutPageFunc);this.b&&this.b.layoutFunc!==this.layoutPageFunc&&(this.b.layoutFunc&&(this.b.layoutFunc_=this.b.layoutFunc),this.b.layoutFunc=this.layoutPageFunc);g&&(n.pageBlurFunc&&n.pageBlurFunc(),e.pageFocusFunc&&e.pageFocusFunc());h=Math.round(h*this.viewScale);l=Math.round(l*this.viewScale);c.remainingWidth=Math.min(Math.max(a.remainingWidth-Math.abs(h),0),a.remainingWidth);c.remainingHeight=Math.min(Math.max(a.remainingHeight-Math.abs(l),0),a.remainingHeight);c.remainingX=
Math.min(Math.max(a.remainingX-(0>h?h:0),a.remainingX),a.remainingX+a.remainingWidth);c.remainingY=Math.min(Math.max(a.remainingY-(0>l?l:0),a.remainingY),a.remainingY+a.remainingHeight);n?f?(d.remainingWidth=a.remainingWidth-c.remainingWidth,d.remainingHeight=a.remainingHeight,d.remainingX=a.remainingX,d.remainingY=a.remainingY,c.remainingX==a.remainingX&&(d.remainingX+=c.remainingWidth)):b&&(d.remainingWidth=a.remainingWidth,d.remainingHeight=a.remainingHeight-c.remainingHeight,d.remainingX=a.remainingX,
d.remainingY=a.remainingY,c.remainingY==a.remainingY&&(d.remainingY+=c.remainingHeight)):d.clear()}else c.clear(),d.clear();this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){super.getHits(a,c);this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ja extends U{constructor(a,c,d,f){super(a);this.type=c;this.stateNew=
this.state="";this.stateProg=0;this.sizeH=d;this.sizeV=f?f:d;this.prop=!1;this.threshold=.5;this.b=this.a=void 0;this.prevTime=0;this.tallState=this.wideState=""}layoutAll(a){super.layoutAll(a);var c=new I(a.totalWidth,a.totalHeight),d=new I(a.totalWidth,a.totalHeight);if(a.hasArea()){var f=~~(this.sizeH*(this.prop?this.w:this.getScale())),b=~~(this.sizeV*(this.prop?this.h:this.getScale())),g=this.stateNew;if(""==this.stateNew){var e=a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)?
!0:!1;"tl"==this.type?(this.wideState="l",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"tr"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):"bl"==this.type?(this.wideState="l",this.tallState="b",this.stateNew=e?this.wideState:this.tallState):"br"==this.type?(this.wideState="r",this.tallState="t",this.stateNew=e?this.wideState:this.tallState):this.stateNew=this.type;this.state=this.stateNew}if(1<this.type.length){e=0;var h=Date.now();
0!=this.prevTime&&(e=h-this.prevTime);this.prevTime=h;17<e&&(e=17);a.remainingWidth*this.threshold>a.remainingHeight*(1-this.threshold)+2&&(this.stateNew=this.wideState);a.remainingHeight*this.threshold>a.remainingWidth*(1-this.threshold)+2&&(this.stateNew=this.tallState);if(this.stateNew!=this.state||0<this.stateProg)this.stateNew!=this.state?(this.stateProg+=.008*e,1<=this.stateProg&&(this.stateProg=1,this.state=this.stateNew),-1===C.indexOf(this)&&C.push(this)):(this.stateProg-=.008*e,0>this.stateProg&&
(this.stateProg=0),0<this.stateProg&&-1===C.indexOf(this)&&C.push(this))}this.layoutFunc&&this.state!=g&&0<this.w&&0<this.h&&this.layoutFunc.call(this);e="t"==this.state||"b"==this.state?b/a.remainingWidth:f/a.remainingHeight;g=1-this.stateProg*(1-e);e=1-this.stateProg*(0+e);"l"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=~~(a.remainingHeight*e),d.remainingX=a.remainingX+b,"t"==this.tallState?
(c.remainingY=a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"r"==this.state?(c.remainingWidth=b,c.remainingHeight=~~(a.remainingHeight*g),c.remainingX=a.remainingX+a.remainingWidth-b,d.remainingWidth=a.remainingWidth-b,d.remainingHeight=~~(a.remainingHeight*e),d.remainingX=a.remainingX,"t"==this.tallState?(c.remainingY=a.remainingY,d.remainingY=a.remainingY+a.remainingHeight-d.remainingHeight):
(c.remainingY=a.remainingY+a.remainingHeight-c.remainingHeight,d.remainingY=a.remainingY)):"t"==this.state?(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY+f,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX)):"b"==
this.state&&(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY+a.remainingHeight-f,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX))}else c.clear(),d.clear();this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}renderAll(){super.renderAll();
...
d.userMat);vec3.transformMat4(f,f,e);f=(a.x-d.x-d.ox)*g+d.userX-this.x-this.xo;d=(a.y-d.y-d.oy)*g+d.userY-this.y-this.yo;if(!(f<b.x1||f>=b.x2||d<b.y1||d>=b.y2)){g=c.length;b=!0;for(e=0;e<g;e+=2){var h=c[e+0];var l=c[e+1];h=(c[(e+2)%g]-h)*(d-l)-(c[(e+3)%g]-l)*(f-h);0>h&&(b=!1)}if(b){g=this.convexHull.length;b=!0;for(e=0;e<g;e+=2)c=this.convexHull[e+0],h=this.convexHull[e+1],h=(this.convexHull[(e+2)%g]-c)*(d-h)-(this.convexHull[(e+3)%g]-h)*(f-c),0>h&&(b=!1);c=0;b||(c=this.distToHull(f,d));a.hits.push({gad:this,
dist:c})}}}}autoHull(){this.convexHull=this.computeHull([0,0,this.w,0,this.w,this.h,0,this.h]);this.extendedHulls={};this.boundingBoxes={}}computeHull(a){function c(t,v,B,F,L,M){return(B-t)*(M-v)-(F-v)*(L-t)}function d(t){return t*t}function f(t,v,B,F,L,M){var H=d(B-L)+d(F-M);if(0==H)return d(t-B)+d(v-F);H=Math.max(0,Math.min(1,((t-B)*(L-B)+(v-F)*(M-F))/H));F+=H*(M-F);return d(t-(B+H*(L-B)))+d(v-F)}function b(t,v,B,F,L,M){if(!(2>v.length)){for(var H=0,R=0,y=0;y<~~(v.length/2);y++){var S=Math.sqrt(f(v[2*
y],v[2*y+1],B,F,L,M));S>R&&(R=S,H=y)}R=v[2*H];S=v[2*H+1];v.splice(2*H,2);for(y=0;y<~~(t.length/2);y++)if(t[2*y]==B&&t[2*y+1]==F&&t[(2*y+2)%t.length]==L&&t[(2*y+3)%t.length]==M||t[2*y]==L&&t[2*y+1]==M&&t[(2*y+2)%t.length]==B&&t[(2*y+3)%t.length]==F){t.splice(2*y+2,0,R,S);break}H=[];var Y=[];for(y=0;y<~~(v.length/2);y++)0>c(B,F,R,S,v[2*y],v[2*y+1])&&(H[H.length]=v[2*y],H[H.length]=v[2*y+1]),0>c(R,S,L,M,v[2*y],v[2*y+1])&&(Y[Y.length]=v[2*y],Y[Y.length]=v[2*y+1]);b(t,H,B,F,R,S);b(t,Y,R,S,L,M)}}for(var g=
[...a],e=[],h=0,l=0,n=g[0],q=g[0],r=0;r<~~(g.length/2);r++)g[2*r]<n&&(n=g[2*r],h=r),g[2*r]>q&&(q=g[2*r],l=r);e[e.length]=g[2*h];e[e.length]=g[2*h+1];e[e.length]=g[2*l];e[e.length]=g[2*l+1];g.splice(2*h,2);l<h?g.splice(2*l,2):g.splice(2*l-2,2);n=[];q=[];for(r=0;r<~~(g.length/2);r++)0>c(a[2*h],a[2*h+1],a[2*l],a[2*l+1],g[2*r],g[2*r+1])?(n[n.length]=g[2*r],n[n.length]=g[2*r+1]):(q[q.length]=g[2*r],q[q.length]=g[2*r+1]);b(e,n,a[2*h],a[2*h+1],a[2*l],a[2*l+1]);b(e,q,a[2*l],a[2*l+1],a[2*h],a[2*h+1]);for(a=
1;a;)for(r=a=0;r<~~(e.length/2);r++)if(.01>Math.sqrt(f(e[(2*r+2)%e.length],e[(2*r+3)%e.length],e[2*r],e[2*r+1],e[(2*r+4)%e.length],e[(2*r+5)%e.length]))){e.splice(2*r+2,2);a=1;break}return this.sortHull(e)}sortHull(a){function c(q){for(q=Math.atan2(a[q+1]-b,a[q+0]-f)-Math.atan2(l-b,h-f);q>Math.PI;)q-=2*Math.PI;for(;q<-Math.PI;)q+=2*Math.PI;return q}for(var d=[],f=0,b=0,g=a.length,e=0;e<g;e+=2)f+=a[e+0],b+=a[e+1];f/=g/2;b/=g/2;for(var h=f+102,l=b+1;0<a.length;){g=0;var n=c(0);for(e=0;e<a.length;e+=
2)c(e)<n&&(g=e,n=c(e));d.push(a[g+0]);d.push(a[g+1]);a.splice(g,2)}return d}computeExtendedHull(a){for(var c=[],d=0,f=this.convexHull.length,b=0;b<f;b+=2){var g=this.convexHull[(b+3)%f]-this.convexHull[b+1],e=-(this.convexHull[(b+2)%f]-this.convexHull[b+0]),h=a/Math.sqrt(g*g+e*e);c[d+0]=this.convexHull[b+0]+g*h;c[d+1]=this.convexHull[b+1]+e*h;d+=2;c[d+0]=this.convexHull[(b+2)%f]+g*h;c[d+1]=this.convexHull[(b+3)%f]+e*h;d+=2}for(b=0;b<f;b+=2){g=this.convexHull[(b+2)%f]-this.convexHull[b+0];e=this.convexHull[(b+
3)%f]-this.convexHull[b+1];d=this.convexHull[(b-2+f)%f]-this.convexHull[b+0];var l=this.convexHull[(b-1+f)%f]-this.convexHull[b+1];h=Math.sqrt(g*g+e*e);l=Math.tan((Math.PI-Math.acos((g*d+e*l)/(h*Math.sqrt(d*d+l*l))))/4)*a;d=2*b;g=c[d+0]-c[d+2];e=c[d+1]-c[d+3];h=Math.sqrt(g*g+e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+0]=g+c[d+2];c[d+1]=e+c[d+3];d=(b-2+f)%f*2;g=c[d+2]-c[d+0];e=c[d+3]-c[d+1];h=Math.sqrt(g*g+e*e);g=g*(h+l)/h;e=e*(h+l)/h;c[d+2]=g+c[d+0];c[d+3]=e+c[d+1]}this.extendedHulls[""+a]=c}computeBoundingBox(a){this.boundingBoxes[""+
...
c,b[0],b[1],b[2],b[3])),e=2;e<b.length;e+=2){var h=Math.sqrt(f(a,c,b[e+0],b[e+1],b[(e+2)%b.length],b[(e+3)%b.length]));h<g&&(g=h)}return g}}class Ka extends X{constructor(a){super(a);this.dragBeginFunc=function(c){this.tempX=c.ox-this.viewport.x;this.tempY=c.oy-this.viewport.y};this.dragMoveFunc=function(c){var d=this.viewport.parent,f="h"==d.state,b=f?c.y-this.tempY-d.a.y:c.x-this.tempX-d.a.x;d.ratio=Math.max(0,Math.min(1,b/(b+(f?d.y+d.h-(c.y-this.tempY+this.viewport.h):d.x+d.w-(c.x-this.tempX+this.viewport.w)))));
...
return m={initialize:Ba,start:Ca,pushRoot:function(a){Z.push(x);x=a;x.queueLayout();V()},peekRoot:function(){return Z[Z.length-1]},popRoot:function(){x=Z.pop();x.queueLayout();V()},getRoot:function(){return x},setRoot:function(a){Z=[];x=a;x.queueLayout();V()},setDebugFlags:function(a,c){Aa=!!a;la=!!c},setKeystrokeSound:function(a){W=a},getContext:function(){return k},getPointerRadius:N,isMouseEnabled:function(){return qa},getInputGad:function(){return T},beginInput:ea,endInput:da,setImage:function(a){if(!J){var c=
k.createShader(k.VERTEX_SHADER),d=k.createShader(k.FRAGMENT_SHADER);k.shaderSource(c,"attribute vec2 aVertex;attribute vec2 aUV;varying vec2 vTex;uniform mat4 pm;uniform mat4 mm;uniform vec2 pos;void main(void) {  gl_Position = pm * mm * vec4(aVertex + pos, 0.0, 1.0);  vTex = aUV;}");k.shaderSource(d,"precision highp float;varying vec2 vTex;uniform sampler2D sampler0;void main(void){  gl_FragColor = texture2D(sampler0, vTex);}");k.compileShader(c);k.compileShader(d);J=k.createProgram();k.attachShader(J,
c);k.attachShader(J,d);k.linkProgram(J);k.useProgram(J);va=k.createBuffer();k.bindBuffer(k.ARRAY_BUFFER,va);k.bufferData(k.ARRAY_BUFFER,new Float32Array([0,0,0,1,1,1,1,0]),k.STATIC_DRAW);wa=k.createBuffer();k.bindBuffer(k.ARRAY_BUFFER,wa);k.bufferData(k.ARRAY_BUFFER,new Float32Array([0,1,0,0,1,0,1,1]),k.STATIC_DRAW);ta=k.getAttribLocation(J,"aVertex");ua=k.getAttribLocation(J,"aUV");k.getUniformLocation(J,"pos")}sa=k.createTexture();k.bindTexture(k.TEXTURE_2D,sa);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_MIN_FILTER,
k.LINEAR);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_MAG_FILTER,k.LINEAR);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE);k.texParameteri(k.TEXTURE_2D,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE);k.texImage2D(k.TEXTURE_2D,0,k.RGBA,k.RGBA,k.UNSIGNED_BYTE,a);return sa},drawImage:function(a,c,d){k.useProgram(J);k.enableVertexAttribArray(ta);k.bindBuffer(k.ARRAY_BUFFER,va);k.vertexAttribPointer(ta,2,k.FLOAT,!1,0,0);k.enableVertexAttribArray(ua);k.bindBuffer(k.ARRAY_BUFFER,wa);k.bindTexture(k.TEXTURE_2D,
a);k.vertexAttribPointer(ua,2,k.FLOAT,!1,0,0);k.uniformMatrix4fv(k.getUniformLocation(J,"pm"),!1,c);k.uniformMatrix4fv(k.getUniformLocation(J,"mm"),!1,d);k.drawArrays(k.TRIANGLE_FAN,0,4)},beep:function(a=""){if(P)switch(a){case "qr-scan":P.setValueAtTime(2,G.currentTime);P.setValueAtTime(3,G.currentTime+.05);P.setValueAtTime(0,G.currentTime+.1);break;case "qr-part":P.setValueAtTime(2,G.currentTime);P.setValueAtTime(0,G.currentTime+.05);break;case "click":ra.setValueAtTime(.1,G.currentTime);ra.setValueAtTime(0,
G.currentTime+.001);break;default:P.setValueAtTime(1,G.currentTime),P.setValueAtTime(0,G.currentTime+.1)}},backAction:function(){var a=new m.HitList(x.w/2,x.h/2);x.getHits(a,Math.sqrt((x.w/2)**2+(x.h/2)**2));a.sortHits();for(const c of a.hits)a=c.gad,!a.ownedBy&&a.actionFlags&m.GAF_BACKNAV&&a.clickFunc&&a.clickFunc.call(a,void 0)},View:U,DividerView:Fa,SliceView:Ha,PagesView:Ia,PopupView:Ja,OverlayView:Ga,ViewPicker:Da,Gadget:X,MatrixGadget:La,SwipeGadget:Ma,MiddleDividerGadget:Ka,GAF_CLICKABLE:1,
GAF_HOLDABLE:2,GAF_CONTEXTMENU:4,GAF_STRETCHABLE:8,GAF_DRAGGABLE_UPDOWN:16,GAF_DRAGGABLE_LEFTRIGHT:32,GAF_DRAGGABLE:48,GAF_SWIPEABLE_UPDOWN:64,GAF_SWIPEABLE_LEFTRIGHT:128,GAF_SWIPEABLE:192,GAF_SCROLLABLE_UPDOWN:256,GAF_SCROLLABLE_LEFTRIGHT:512,GAF_SCROLLABLE:768,GAF_SCALABLE:1024,GAF_ROTATABLE:2048,GAF_PINCHABLE:3072,GAF_NUMINPUT:4096,GAF_TEXTINPUT:8192,GAF_GONEXT:16384,GAF_BACKNAV:32768,GAF_ALL:3901,HitList:Ea,LayoutState:I}}();
