...
this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}setRenderFlag(a){super.setRenderFlag(!0)}renderAll(){super.renderAll();if(this.a&&(this.a.needsRender||this.a.childRender)||this.b&&(this.b.needsRender||this.b.childRender)){this.b.renderAll();this.clip();const a=this.ghostOpacity||.5;if(0<a||this.ghostColor?.[3]){let c=this.ghostColor;!c&&this.b?.bgColor&&(c=[this.b.bgColor[0],this.b.bgColor[1],this.b.bgColor[2],a]);k.clearColor(...(c||[.5,.5,.5,a]));k.clear(k.COLOR_BUFFER_BIT)}this.a.renderAll(!1)}}getHits(a,
...
f,d.remainingY=a.remainingY+f,"l"==this.wideState?(c.remainingX=a.remainingX,d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX)):"b"==this.state&&(c.remainingWidth=~~(a.remainingWidth*g),c.remainingHeight=f,c.remainingY=a.remainingY+a.remainingHeight-f,d.remainingWidth=~~(a.remainingWidth*e),d.remainingHeight=a.remainingHeight-f,d.remainingY=a.remainingY,"l"==this.wideState?(c.remainingX=a.remainingX,
d.remainingX=a.remainingX+a.remainingWidth-d.remainingWidth):(c.remainingX=a.remainingX+a.remainingWidth-c.remainingWidth,d.remainingX=a.remainingX))}else c.clear(),d.clear();this.a&&this.a.layoutAll(c);this.b&&this.b.layoutAll(d)}renderAll(){super.renderAll();this.a&&(this.a.needsRender||this.a.childRender)&&this.a.renderAll();this.b&&(this.b.needsRender||this.b.childRender)&&this.b.renderAll()}getHits(a,c){this.a&&this.a.getHits(a,c);this.b&&this.b.getHits(a,c)}}class Ca extends U{constructor(a){super(a);
this.gadgets.push(a=new X(this));a.w=1E3;a.h=1E3;a.convexHull=a.computeHull([0,0,0,1E3,1E3,1E3,1E3,0]);a.click=function(){}}}class X{constructor(a){this.viewport=a;this.mat=mat4.create();mat4.identity(this.mat);this.H=this.h=this.w=this.y=this.x=0;this.convexHull=[];this.extendedHulls={};this.boundingBoxes={};this.yo=this.xo=0;this.enabled=!0;this.selected=!1;this.actionFlags=0}getHits(a,c){if(this.enabled&&0!=this.convexHull.length){var d=this.viewport,f=vec3.create();mat4.getScaling(f,d.userMat);
...
2)%g]-h)*(d-l)-(c[(e+3)%g]-l)*(f-h);0>h&&(b=!1)}if(b){g=this.convexHull.length;b=!0;for(e=0;e<g;e+=2)c=this.convexHull[e+0],h=this.convexHull[e+1],h=(this.convexHull[(e+2)%g]-c)*(d-h)-(this.convexHull[(e+3)%g]-h)*(f-c),0>h&&(b=!1);c=0;b||(c=this.distToHull(f,d));a.hits.push({gad:this,dist:c})}}}}autoHull(){this.convexHull=this.computeHull([0,0,this.w,0,this.w,this.h,0,this.h]);this.extendedHulls={};this.boundingBoxes={}}computeHull(a){function c(t,v,A,E,L,M){return(A-t)*(M-v)-(E-v)*(L-t)}function d(t){return t*
t}function f(t,v,A,E,L,M){var H=d(A-L)+d(E-M);if(0==H)return d(t-A)+d(v-E);H=Math.max(0,Math.min(1,((t-A)*(L-A)+(v-E)*(M-E))/H));E+=H*(M-E);return d(t-(A+H*(L-A)))+d(v-E)}function b(t,v,A,E,L,M){if(!(2>v.length)){for(var H=0,R=0,y=0;y<~~(v.length/2);y++){var S=Math.sqrt(f(v[2*y],v[2*y+1],A,E,L,M));S>R&&(R=S,H=y)}R=v[2*H];S=v[2*H+1];v.splice(2*H,2);for(y=0;y<~~(t.length/2);y++)if(t[2*y]==A&&t[2*y+1]==E&&t[(2*y+2)%t.length]==L&&t[(2*y+3)%t.length]==M||t[2*y]==L&&t[2*y+1]==M&&t[(2*y+2)%t.length]==A&&
t[(2*y+3)%t.length]==E){t.splice(2*y+2,0,R,S);break}H=[];var Y=[];for(y=0;y<~~(v.length/2);y++)0>c(A,E,R,S,v[2*y],v[2*y+1])&&(H[H.length]=v[2*y],H[H.length]=v[2*y+1]),0>c(R,S,L,M,v[2*y],v[2*y+1])&&(Y[Y.length]=v[2*y],Y[Y.length]=v[2*y+1]);b(t,H,A,E,R,S);b(t,Y,R,S,L,M)}}for(var g=[...a],e=[],h=0,l=0,n=g[0],q=g[0],r=0;r<~~(g.length/2);r++)g[2*r]<n&&(n=g[2*r],h=r),g[2*r]>q&&(q=g[2*r],l=r);e[e.length]=g[2*h];e[e.length]=g[2*h+1];e[e.length]=g[2*l];e[e.length]=g[2*l+1];g.splice(2*h,2);l<h?g.splice(2*l,
2):g.splice(2*l-2,2);n=[];q=[];for(r=0;r<~~(g.length/2);r++)0>c(a[2*h],a[2*h+1],a[2*l],a[2*l+1],g[2*r],g[2*r+1])?(n[n.length]=g[2*r],n[n.length]=g[2*r+1]):(q[q.length]=g[2*r],q[q.length]=g[2*r+1]);b(e,n,a[2*h],a[2*h+1],a[2*l],a[2*l+1]);b(e,q,a[2*l],a[2*l+1],a[2*h],a[2*h+1]);for(a=1;a;)for(r=a=0;r<~~(e.length/2);r++)if(.01>Math.sqrt(f(e[(2*r+2)%e.length],e[(2*r+3)%e.length],e[2*r],e[2*r+1],e[(2*r+4)%e.length],e[(2*r+5)%e.length]))){e.splice(2*r+2,2);a=1;break}return this.sortHull(e)}sortHull(a){function c(q){for(q=
Math.atan2(a[q+1]-b,a[q+0]-f)-Math.atan2(l-b,h-f);q>Math.PI;)q-=2*Math.PI;for(;q<-Math.PI;)q+=2*Math.PI;return q}for(var d=[],f=0,b=0,g=a.length,e=0;e<g;e+=2)f+=a[e+0],b+=a[e+1];f/=g/2;b/=g/2;for(var h=f+102,l=b+1;0<a.length;){g=0;var n=c(0);for(e=0;e<a.length;e+=2)c(e)<n&&(g=e,n=c(e));d.push(a[g+0]);d.push(a[g+1]);a.splice(g,2)}return d}computeExtendedHull(a){for(var c=[],d=0,f=this.convexHull.length,b=0;b<f;b+=2){var g=this.convexHull[(b+3)%f]-this.convexHull[b+1],e=-(this.convexHull[(b+2)%f]-this.convexHull[b+
0]),h=a/Math.sqrt(g*g+e*e);c[d+0]=this.convexHull[b+0]+g*h;c[d+1]=this.convexHull[b+1]+e*h;d+=2;c[d+0]=this.convexHull[(b+2)%f]+g*h;c[d+1]=this.convexHull[(b+3)%f]+e*h;d+=2}for(b=0;b<f;b+=2){g=this.convexHull[(b+2)%f]-this.convexHull[b+0];e=this.convexHull[(b+3)%f]-this.convexHull[b+1];d=this.convexHull[(b-2+f)%f]-this.convexHull[b+0];var l=this.convexHull[(b-1+f)%f]-this.convexHull[b+1];h=Math.sqrt(g*g+e*e);l=Math.tan((Math.PI-Math.acos((g*d+e*l)/(h*Math.sqrt(d*d+l*l))))/4)*a;d=2*b;g=c[d+0]-c[d+
