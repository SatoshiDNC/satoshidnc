...
export function followChannel(id) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const req = os.add({ id, timestamp: now })
    req.onerror = function(e) {
      if (e?.target?.error?.name === 'ConstraintError') {
        console.log(`[${TAG}] channel already followed '${id}'`)
        resolve()
      } else {
        console.log(`[${TAG}] '${id}'`)
        console.error(e)
    ...
    req.onsuccess = function(e) {
      console.log(`[${TAG}] followed channel '${id}'`)
      resolve()
    }
  })
}
...
export function unfollowChannel(id) {
  ...
  return new Promise((resolve, reject) => {
    ...
    req.onerror = function(e) {
      if (e?.target?.error?.name === 'ConstraintError') {
        console.log(`[${TAG}] channel already unfollowed '${id}'`)
        resolve()
      } else {
        console.log(`[${TAG}] '${id}'`)
        console.error(e)
    ...
    req.onsuccess = function(e) {
      console.log(`[${TAG}] unfollowed channel '${id}'`)
      resolve()
    }
  })
}
