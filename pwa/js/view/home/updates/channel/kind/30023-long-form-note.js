...
export function prep_kind30023(view, post) {
  ...
  if (flag) {
    let key = Uint8Array.from("0102030405060708090001020304050607080900010203040506070809000102030405060708090001020304")
    ...
    let x = crypt(0, Uint8Array.from(test), key)
    let y = crypt(0, x, key)
