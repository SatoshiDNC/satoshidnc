      ...
      sign(v.hpub, [
        {
          ...
          tags: [['bgcolor', `${rrggbb(contentView.bgColor)}`], ['expiration', `${Math.ceil((Date.now() + ONE_DAY_IN_MILLISECONDS)/1000)}`], ['encryption', 'cc20s10' /*chacha20 stream, 2^10 bytes per chunk*/], ['c', '1']],
        }, {
          kind: 555,
