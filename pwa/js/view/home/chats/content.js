...
keyDependencies.push(() => { console.log('key trig'); setTimeout(() => { v.relayout(); v.queueLayout() }) })
contactDependencies.push(() => { console.log('contact trig'); setTimeout(() => { v.relayout(); v.queueLayout() }) })
