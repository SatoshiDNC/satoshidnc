...
export function drawAvatar(v, hpub, x,y,w,h, hearts) {
  ...
  if (mode == 'character') {
    ...
    defaultFont.draw(-defaultFont.glyphX1[i]+(-diameter+defaultFont.glyphWidths[i])/2, defaultFont.glyphHeights[i]-defaultFont.glyphY1[i]+(-diameter+defaultFont.glyphHeights[i])/2, String.fromCodePoint(i), color, v.mat, m)
  }
